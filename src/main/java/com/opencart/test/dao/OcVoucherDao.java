...
public interface OcVoucherDao {
    /**
     * Retrieve all records OcVoucher.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcVoucher
     */
     ...
     * Find an entity.
     *
     * @param id An OcVoucher id.
     * @return The same OcVoucher.
     */
     ...
     * Create an OcVoucher.
     *
     * @param e the OcVoucher.
     * @return The same OcVoucher.
     */
    public OcVoucher create(OcVoucher e);

    /**
     * Update the OcVoucher.
     *
     * @param e the OcVoucher.
     * @return The same OcVoucher.
     */
