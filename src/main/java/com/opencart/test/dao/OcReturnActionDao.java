...
public interface OcReturnActionDao {
    /**
     * Retrieve all records OcReturnAction.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcReturnAction
     */
     ...
     * Find an entity.
     *
     * @param id An OcReturnAction id.
     * @return The same OcReturnAction.
     */
    public OcReturnAction find(OcReturnActionId id);
    /**
     * Create an OcReturnAction.
     *
     * @param e the OcReturnAction.
     * @return The same OcReturnAction.
     */
    public OcReturnAction create(OcReturnAction e);

    /**
     * Update the OcReturnAction.
     *
     * @param e the OcReturnAction.
     * @return The same OcReturnAction.
     */
