...
public interface OcCategoryToStoreDao {
    /**
     * Retrieve all records OcCategoryToStore.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcCategoryToStore
     */
     ...
     * Find an entity.
     *
     * @param id An OcCategoryToStore id.
     * @return The same OcCategoryToStore.
     */
    public OcCategoryToStore find(OcCategoryToStoreId id);
    /**
     * Create an OcCategoryToStore.
     *
     * @param e the OcCategoryToStore.
     * @return The same OcCategoryToStore.
     */
    public OcCategoryToStore create(OcCategoryToStore e);

    /**
     * Update the OcCategoryToStore.
     *
     * @param e the OcCategoryToStore.
     * @return The same OcCategoryToStore.
     */
