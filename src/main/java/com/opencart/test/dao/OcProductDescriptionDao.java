...
public interface OcProductDescriptionDao {
    /**
     * Retrieve all records OcProductDescription.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcProductDescription
     */
     ...
     * Find an entity.
     *
     * @param id An OcProductDescription id.
     * @return The same OcProductDescription.
     */
    public OcProductDescription find(OcProductDescriptionId id);
    /**
     * Create an OcProductDescription.
     *
     * @param e the OcProductDescription.
     * @return The same OcProductDescription.
     */
    public OcProductDescription create(OcProductDescription e);

    /**
     * Update the OcProductDescription.
     *
     * @param e the OcProductDescription.
     * @return The same OcProductDescription.
     */
