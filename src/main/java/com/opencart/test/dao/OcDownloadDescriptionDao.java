...
public interface OcDownloadDescriptionDao {
    /**
     * Retrieve all records OcDownloadDescription.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcDownloadDescription
     */
     ...
     * Find an entity.
     *
     * @param id An OcDownloadDescription id.
     * @return The same OcDownloadDescription.
     */
    public OcDownloadDescription find(OcDownloadDescriptionId id);
    /**
     * Create an OcDownloadDescription.
     *
     * @param e the OcDownloadDescription.
     * @return The same OcDownloadDescription.
     */
    public OcDownloadDescription create(OcDownloadDescription e);

    /**
     * Update the OcDownloadDescription.
     *
     * @param e the OcDownloadDescription.
     * @return The same OcDownloadDescription.
     */
