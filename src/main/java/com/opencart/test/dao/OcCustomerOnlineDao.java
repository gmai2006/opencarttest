...
public interface OcCustomerOnlineDao {
    /**
     * Retrieve all records OcCustomerOnline.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcCustomerOnline
     */
     ...
     * Find an entity.
     *
     * @param id An OcCustomerOnline id.
     * @return The same OcCustomerOnline.
     */
    public OcCustomerOnline find(java.lang.String id);

    /**
     * Create an OcCustomerOnline.
     *
     * @param e the OcCustomerOnline.
     * @return The same OcCustomerOnline.
     */
    public OcCustomerOnline create(OcCustomerOnline e);

    /**
     * Update the OcCustomerOnline.
     *
     * @param e the OcCustomerOnline.
     * @return The same OcCustomerOnline.
     */
