...
public interface OcAttributeGroupDao {
    /**
     * Retrieve all records OcAttributeGroup.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcAttributeGroup
     */
     ...
     * Find an entity.
     *
     * @param id An OcAttributeGroup id.
     * @return The same OcAttributeGroup.
     */
    public OcAttributeGroup find(java.lang.Integer id);

    /**
     * Create an OcAttributeGroup.
     *
     * @param e the OcAttributeGroup.
     * @return The same OcAttributeGroup.
     */
    public OcAttributeGroup create(OcAttributeGroup e);

    /**
     * Update the OcAttributeGroup.
     *
     * @param e the OcAttributeGroup.
     * @return The same OcAttributeGroup.
     */
