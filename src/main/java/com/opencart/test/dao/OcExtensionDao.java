...
public interface OcExtensionDao {
    /**
     * Retrieve all records OcExtension.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcExtension
     */
     ...
     * Find an entity.
     *
     * @param id An OcExtension id.
     * @return The same OcExtension.
     */
    public OcExtension find(java.lang.Integer id);

    /**
     * Create an OcExtension.
     *
     * @param e the OcExtension.
     * @return The same OcExtension.
     */
    public OcExtension create(OcExtension e);

    /**
     * Update the OcExtension.
     *
     * @param e the OcExtension.
     * @return The same OcExtension.
     */
