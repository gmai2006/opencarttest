...
public interface OcLocationDao {
    /**
     * Retrieve all records OcLocation.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcLocation
     */
     ...
     * Find an entity.
     *
     * @param id An OcLocation id.
     * @return The same OcLocation.
     */
    public OcLocation find(java.lang.Integer id);

    /**
     * Create an OcLocation.
     *
     * @param e the OcLocation.
     * @return The same OcLocation.
     */
    public OcLocation create(OcLocation e);

    /**
     * Update the OcLocation.
     *
     * @param e the OcLocation.
     * @return The same OcLocation.
     */
