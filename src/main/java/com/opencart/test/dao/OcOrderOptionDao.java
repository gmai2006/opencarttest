...
public interface OcOrderOptionDao {
    /**
     * Retrieve all records OcOrderOption.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcOrderOption
     */
     ...
     * Find an entity.
     *
     * @param id An OcOrderOption id.
     * @return The same OcOrderOption.
     */
    public OcOrderOption find(java.lang.Integer id);

    /**
     * Create an OcOrderOption.
     *
     * @param e the OcOrderOption.
     * @return The same OcOrderOption.
     */
    public OcOrderOption create(OcOrderOption e);

    /**
     * Update the OcOrderOption.
     *
     * @param e the OcOrderOption.
     * @return The same OcOrderOption.
     */
