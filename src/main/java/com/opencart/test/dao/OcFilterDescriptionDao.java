...
public interface OcFilterDescriptionDao {
    /**
     * Retrieve all records OcFilterDescription.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcFilterDescription
     */
     ...
     * Find an entity.
     *
     * @param id An OcFilterDescription id.
     * @return The same OcFilterDescription.
     */
    public OcFilterDescription find(OcFilterDescriptionId id);
    /**
     * Create an OcFilterDescription.
     *
     * @param e the OcFilterDescription.
     * @return The same OcFilterDescription.
     */
    public OcFilterDescription create(OcFilterDescription e);

    /**
     * Update the OcFilterDescription.
     *
     * @param e the OcFilterDescription.
     * @return The same OcFilterDescription.
     */
