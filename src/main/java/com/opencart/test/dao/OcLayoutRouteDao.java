...
public interface OcLayoutRouteDao {
    /**
     * Retrieve all records OcLayoutRoute.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcLayoutRoute
     */
     ...
     * Find an entity.
     *
     * @param id An OcLayoutRoute id.
     * @return The same OcLayoutRoute.
     */
    public OcLayoutRoute find(java.lang.Integer id);

    /**
     * Create an OcLayoutRoute.
     *
     * @param e the OcLayoutRoute.
     * @return The same OcLayoutRoute.
     */
    public OcLayoutRoute create(OcLayoutRoute e);

    /**
     * Update the OcLayoutRoute.
     *
     * @param e the OcLayoutRoute.
     * @return The same OcLayoutRoute.
     */
