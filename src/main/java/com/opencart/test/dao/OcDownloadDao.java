...
public interface OcDownloadDao {
    /**
     * Retrieve all records OcDownload.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcDownload
     */
     ...
     * Find an entity.
     *
     * @param id An OcDownload id.
     * @return The same OcDownload.
     */
    public OcDownload find(java.lang.Integer id);

    /**
     * Create an OcDownload.
     *
     * @param e the OcDownload.
     * @return The same OcDownload.
     */
    public OcDownload create(OcDownload e);

    /**
     * Update the OcDownload.
     *
     * @param e the OcDownload.
     * @return The same OcDownload.
     */
