...
public interface OcOptionDescriptionDao {
    /**
     * Retrieve all records OcOptionDescription.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcOptionDescription
     */
     ...
     * Find an entity.
     *
     * @param id An OcOptionDescription id.
     * @return The same OcOptionDescription.
     */
    public OcOptionDescription find(OcOptionDescriptionId id);
    /**
     * Create an OcOptionDescription.
     *
     * @param e the OcOptionDescription.
     * @return The same OcOptionDescription.
     */
    public OcOptionDescription create(OcOptionDescription e);

    /**
     * Update the OcOptionDescription.
     *
     * @param e the OcOptionDescription.
     * @return The same OcOptionDescription.
     */
