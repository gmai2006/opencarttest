...
public interface OcCustomFieldDescriptionDao {
    /**
     * Retrieve all records OcCustomFieldDescription.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcCustomFieldDescription
     */
     ...
     * Find an entity.
     *
     * @param id An OcCustomFieldDescription id.
     * @return The same OcCustomFieldDescription.
     */
    public OcCustomFieldDescription find(OcCustomFieldDescriptionId id);
    /**
     * Create an OcCustomFieldDescription.
     *
     * @param e the OcCustomFieldDescription.
     * @return The same OcCustomFieldDescription.
     */
    public OcCustomFieldDescription create(OcCustomFieldDescription e);

    /**
     * Update the OcCustomFieldDescription.
     *
     * @param e the OcCustomFieldDescription.
     * @return The same OcCustomFieldDescription.
     */
