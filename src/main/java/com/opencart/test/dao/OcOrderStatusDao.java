...
public interface OcOrderStatusDao {
    /**
     * Retrieve all records OcOrderStatus.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcOrderStatus
     */
     ...
     * Find an entity.
     *
     * @param id An OcOrderStatus id.
     * @return The same OcOrderStatus.
     */
    public OcOrderStatus find(OcOrderStatusId id);
    /**
     * Create an OcOrderStatus.
     *
     * @param e the OcOrderStatus.
     * @return The same OcOrderStatus.
     */
    public OcOrderStatus create(OcOrderStatus e);

    /**
     * Update the OcOrderStatus.
     *
     * @param e the OcOrderStatus.
     * @return The same OcOrderStatus.
     */
