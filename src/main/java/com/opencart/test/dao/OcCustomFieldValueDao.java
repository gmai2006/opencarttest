...
public interface OcCustomFieldValueDao {
    /**
     * Retrieve all records OcCustomFieldValue.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcCustomFieldValue
     */
     ...
     * Find an entity.
     *
     * @param id An OcCustomFieldValue id.
     * @return The same OcCustomFieldValue.
     */
    public OcCustomFieldValue find(java.lang.Integer id);

    /**
     * Create an OcCustomFieldValue.
     *
     * @param e the OcCustomFieldValue.
     * @return The same OcCustomFieldValue.
     */
    public OcCustomFieldValue create(OcCustomFieldValue e);

    /**
     * Update the OcCustomFieldValue.
     *
     * @param e the OcCustomFieldValue.
     * @return The same OcCustomFieldValue.
     */
