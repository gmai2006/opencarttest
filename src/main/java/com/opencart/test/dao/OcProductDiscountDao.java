...
public interface OcProductDiscountDao {
    /**
     * Retrieve all records OcProductDiscount.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcProductDiscount
     */
     ...
     * Find an entity.
     *
     * @param id An OcProductDiscount id.
     * @return The same OcProductDiscount.
     */
    public OcProductDiscount find(java.lang.Integer id);

    /**
     * Create an OcProductDiscount.
     *
     * @param e the OcProductDiscount.
     * @return The same OcProductDiscount.
     */
    public OcProductDiscount create(OcProductDiscount e);

    /**
     * Update the OcProductDiscount.
     *
     * @param e the OcProductDiscount.
     * @return The same OcProductDiscount.
     */
