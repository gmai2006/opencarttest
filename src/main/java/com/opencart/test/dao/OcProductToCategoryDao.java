...
public interface OcProductToCategoryDao {
    /**
     * Retrieve all records OcProductToCategory.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcProductToCategory
     */
     ...
     * Find an entity.
     *
     * @param id An OcProductToCategory id.
     * @return The same OcProductToCategory.
     */
    public OcProductToCategory find(OcProductToCategoryId id);
    /**
     * Create an OcProductToCategory.
     *
     * @param e the OcProductToCategory.
     * @return The same OcProductToCategory.
     */
    public OcProductToCategory create(OcProductToCategory e);

    /**
     * Update the OcProductToCategory.
     *
     * @param e the OcProductToCategory.
     * @return The same OcProductToCategory.
     */
