...
public interface OcWeightClassDao {
    /**
     * Retrieve all records OcWeightClass.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcWeightClass
     */
     ...
     * Find an entity.
     *
     * @param id An OcWeightClass id.
     * @return The same OcWeightClass.
     */
    public OcWeightClass find(java.lang.Integer id);

    /**
     * Create an OcWeightClass.
     *
     * @param e the OcWeightClass.
     * @return The same OcWeightClass.
     */
    public OcWeightClass create(OcWeightClass e);

    /**
     * Update the OcWeightClass.
     *
     * @param e the OcWeightClass.
     * @return The same OcWeightClass.
     */
