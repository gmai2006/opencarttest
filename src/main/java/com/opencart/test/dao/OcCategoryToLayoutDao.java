...
public interface OcCategoryToLayoutDao {
    /**
     * Retrieve all records OcCategoryToLayout.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcCategoryToLayout
     */
     ...
     * Find an entity.
     *
     * @param id An OcCategoryToLayout id.
     * @return The same OcCategoryToLayout.
     */
    public OcCategoryToLayout find(OcCategoryToLayoutId id);
    /**
     * Create an OcCategoryToLayout.
     *
     * @param e the OcCategoryToLayout.
     * @return The same OcCategoryToLayout.
     */
    public OcCategoryToLayout create(OcCategoryToLayout e);

    /**
     * Update the OcCategoryToLayout.
     *
     * @param e the OcCategoryToLayout.
     * @return The same OcCategoryToLayout.
     */
