...
public interface OcAffiliateLoginDao {
    /**
     * Retrieve all records OcAffiliateLogin.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcAffiliateLogin
     */
     ...
     * Find an entity.
     *
     * @param id An OcAffiliateLogin id.
     * @return The same OcAffiliateLogin.
     */
    public OcAffiliateLogin find(java.lang.Integer id);

    /**
     * Create an OcAffiliateLogin.
     *
     * @param e the OcAffiliateLogin.
     * @return The same OcAffiliateLogin.
     */
    public OcAffiliateLogin create(OcAffiliateLogin e);

    /**
     * Update the OcAffiliateLogin.
     *
     * @param e the OcAffiliateLogin.
     * @return The same OcAffiliateLogin.
     */
