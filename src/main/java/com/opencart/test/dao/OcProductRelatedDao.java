...
public interface OcProductRelatedDao {
    /**
     * Retrieve all records OcProductRelated.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of OcProductRelated
     */
     ...
     * Find an entity.
     *
     * @param id An OcProductRelated id.
     * @return The same OcProductRelated.
     */
    public OcProductRelated find(OcProductRelatedId id);
    /**
     * Create an OcProductRelated.
     *
     * @param e the OcProductRelated.
     * @return The same OcProductRelated.
     */
    public OcProductRelated create(OcProductRelated e);

    /**
     * Update the OcProductRelated.
     *
     * @param e the OcProductRelated.
     * @return The same OcProductRelated.
     */
