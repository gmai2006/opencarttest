...
public interface OcCustomFieldService {
    public OcCustomField find(java.lang.Integer id);

    /**
     * Select a list of OcCustomField based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCustomField records.
     */
    public List<OcCustomField> select(int maxResult);

    /**
     * Select all OcCustomField.
     *
     * @return all OcCustomField records.
     */
    public List<OcCustomField> selectAll();

    /**
     * Create OcCustomField.
     *
     * @param bean The OcCustomField.
     * @return The OcCustomField.
     */
    public OcCustomField create(OcCustomField bean);

    /**
     * Update a OcCustomField.
     *
     * @param bean - The OcCustomField.
