...
public interface OcProductRelatedService {
    public OcProductRelated find(OcProductRelatedId id);
    /**
     * Select a list of OcProductRelated based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcProductRelated records.
     */
    public List<OcProductRelated> select(int maxResult);

    /**
     * Select all OcProductRelated.
     *
     * @return all OcProductRelated records.
     */
    public List<OcProductRelated> selectAll();

    /**
     * Create OcProductRelated.
     *
     * @param bean The OcProductRelated.
     * @return The OcProductRelated.
     */
    public OcProductRelated create(OcProductRelated bean);

    /**
     * Update a OcProductRelated.
     *
     * @param bean - The OcProductRelated.
