...
public interface OcProductToDownloadService {
    public OcProductToDownload find(OcProductToDownloadId id);
    /**
     * Select a list of OcProductToDownload based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcProductToDownload records.
     */
    public List<OcProductToDownload> select(int maxResult);

    /**
     * Select all OcProductToDownload.
     *
     * @return all OcProductToDownload records.
     */
    public List<OcProductToDownload> selectAll();

    /**
     * Create OcProductToDownload.
     *
     * @param bean The OcProductToDownload.
     * @return The OcProductToDownload.
     */
    public OcProductToDownload create(OcProductToDownload bean);

    /**
     * Update a OcProductToDownload.
     *
     * @param bean - The OcProductToDownload.
