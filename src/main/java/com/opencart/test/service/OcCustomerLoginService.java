...
public interface OcCustomerLoginService {
    public OcCustomerLogin find(java.lang.Integer id);

    /**
     * Select a list of OcCustomerLogin based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCustomerLogin records.
     */
    public List<OcCustomerLogin> select(int maxResult);

    /**
     * Select all OcCustomerLogin.
     *
     * @return all OcCustomerLogin records.
     */
    public List<OcCustomerLogin> selectAll();

    /**
     * Create OcCustomerLogin.
     *
     * @param bean The OcCustomerLogin.
     * @return The OcCustomerLogin.
     */
    public OcCustomerLogin create(OcCustomerLogin bean);

    /**
     * Update a OcCustomerLogin.
     *
     * @param bean - The OcCustomerLogin.
