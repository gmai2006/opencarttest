...
public interface OcVoucherService {
    public OcVoucher find(java.lang.Integer id);

    /**
     * Select a list of OcVoucher based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcVoucher records.
     */
    public List<OcVoucher> select(int maxResult);

    /**
     * Select all OcVoucher.
     *
     * @return all OcVoucher records.
     */
