...
public interface OcProductService {
    ...
    /**
     * Select a list of OcProduct based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcProduct records.
     */
    public List<OcProduct> select(int maxResult);

    /**
     * Select all OcProduct.
     *
     * @return all OcProduct records.
     */
