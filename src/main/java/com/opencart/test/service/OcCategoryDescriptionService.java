...
public interface OcCategoryDescriptionService {
    ...
    /**
     * Select a list of OcCategoryDescription based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCategoryDescription records.
     */
    public List<OcCategoryDescription> select(int maxResult);

    /**
     * Select all OcCategoryDescription.
     *
     * @return all OcCategoryDescription records.
     */
    public List<OcCategoryDescription> selectAll();

    /**
     * Create OcCategoryDescription.
     *
     * @param bean The OcCategoryDescription.
     * @return The OcCategoryDescription.
     */
    public OcCategoryDescription create(OcCategoryDescription bean);

    /**
     * Update a OcCategoryDescription.
     *
     * @param bean - The OcCategoryDescription.
