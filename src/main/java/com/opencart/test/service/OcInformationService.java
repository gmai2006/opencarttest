...
public interface OcInformationService {
    public OcInformation find(java.lang.Integer id);

    /**
     * Select a list of OcInformation based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcInformation records.
     */
    public List<OcInformation> select(int maxResult);

    /**
     * Select all OcInformation.
     *
     * @return all OcInformation records.
     */
    public List<OcInformation> selectAll();

    /**
     * Create OcInformation.
     *
     * @param bean The OcInformation.
     * @return The OcInformation.
     */
    public OcInformation create(OcInformation bean);

    /**
     * Update a OcInformation.
     *
     * @param bean - The OcInformation.
