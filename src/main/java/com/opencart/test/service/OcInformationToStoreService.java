...
public interface OcInformationToStoreService {
    public OcInformationToStore find(OcInformationToStoreId id);
    /**
     * Select a list of OcInformationToStore based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcInformationToStore records.
     */
    public List<OcInformationToStore> select(int maxResult);

    /**
     * Select all OcInformationToStore.
     *
     * @return all OcInformationToStore records.
     */
    public List<OcInformationToStore> selectAll();

    /**
     * Create OcInformationToStore.
     *
     * @param bean The OcInformationToStore.
     * @return The OcInformationToStore.
     */
    public OcInformationToStore create(OcInformationToStore bean);

    /**
     * Update a OcInformationToStore.
     *
     * @param bean - The OcInformationToStore.
