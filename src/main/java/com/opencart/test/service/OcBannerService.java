...
public interface OcBannerService {
    public OcBanner find(java.lang.Integer id);

    /**
     * Select a list of OcBanner based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcBanner records.
     */
