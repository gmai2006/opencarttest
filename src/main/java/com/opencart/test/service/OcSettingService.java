...
public interface OcSettingService {
    ...
    /**
     * Select a list of OcSetting based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcSetting records.
     */
    public List<OcSetting> select(int maxResult);

    /**
     * Select all OcSetting.
     *
     * @return all OcSetting records.
     */
