...
public interface OcThemeService {
    public OcTheme find(java.lang.Integer id);

    /**
     * Select a list of OcTheme based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcTheme records.
     */
