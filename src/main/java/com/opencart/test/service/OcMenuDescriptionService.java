...
public interface OcMenuDescriptionService {
    public OcMenuDescription find(OcMenuDescriptionId id);
    /**
     * Select a list of OcMenuDescription based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcMenuDescription records.
     */
    public List<OcMenuDescription> select(int maxResult);

    /**
     * Select all OcMenuDescription.
     *
     * @return all OcMenuDescription records.
     */
    public List<OcMenuDescription> selectAll();

    /**
     * Create OcMenuDescription.
     *
     * @param bean The OcMenuDescription.
     * @return The OcMenuDescription.
     */
    public OcMenuDescription create(OcMenuDescription bean);

    /**
     * Update a OcMenuDescription.
     *
     * @param bean - The OcMenuDescription.
