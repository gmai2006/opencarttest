...
public interface OcCustomerGroupService {
    public OcCustomerGroup find(java.lang.Integer id);

    /**
     * Select a list of OcCustomerGroup based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCustomerGroup records.
     */
    public List<OcCustomerGroup> select(int maxResult);

    /**
     * Select all OcCustomerGroup.
     *
     * @return all OcCustomerGroup records.
     */
    public List<OcCustomerGroup> selectAll();

    /**
     * Create OcCustomerGroup.
     *
     * @param bean The OcCustomerGroup.
     * @return The OcCustomerGroup.
     */
    public OcCustomerGroup create(OcCustomerGroup bean);

    /**
     * Update a OcCustomerGroup.
     *
     * @param bean - The OcCustomerGroup.
