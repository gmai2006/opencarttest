...
public interface OcOptionValueService {
    ...
    /**
     * Select a list of OcOptionValue based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcOptionValue records.
     */
    public List<OcOptionValue> select(int maxResult);

    /**
     * Select all OcOptionValue.
     *
     * @return all OcOptionValue records.
     */
    public List<OcOptionValue> selectAll();

    /**
     * Create OcOptionValue.
     *
     * @param bean The OcOptionValue.
     * @return The OcOptionValue.
     */
    public OcOptionValue create(OcOptionValue bean);

    /**
     * Update a OcOptionValue.
     *
     * @param bean - The OcOptionValue.
