...
public interface OcTaxRateService {
    public OcTaxRate find(java.lang.Integer id);

    /**
     * Select a list of OcTaxRate based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcTaxRate records.
     */
    public List<OcTaxRate> select(int maxResult);

    /**
     * Select all OcTaxRate.
     *
     * @return all OcTaxRate records.
     */
