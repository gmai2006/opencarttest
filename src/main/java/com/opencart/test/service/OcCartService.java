...
public interface OcCartService {
    public OcCart find(java.lang.Integer id);

    /**
     * Select a list of OcCart based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCart records.
     */
