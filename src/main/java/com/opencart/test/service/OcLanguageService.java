...
public interface OcLanguageService {
    ...
    /**
     * Select a list of OcLanguage based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcLanguage records.
     */
    public List<OcLanguage> select(int maxResult);

    /**
     * Select all OcLanguage.
     *
     * @return all OcLanguage records.
     */
