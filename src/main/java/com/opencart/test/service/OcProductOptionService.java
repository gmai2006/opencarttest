...
public interface OcProductOptionService {
    ...
    /**
     * Select a list of OcProductOption based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcProductOption records.
     */
    public List<OcProductOption> select(int maxResult);

    /**
     * Select all OcProductOption.
     *
     * @return all OcProductOption records.
     */
    public List<OcProductOption> selectAll();

    /**
     * Create OcProductOption.
     *
     * @param bean The OcProductOption.
     * @return The OcProductOption.
     */
    public OcProductOption create(OcProductOption bean);

    /**
     * Update a OcProductOption.
     *
     * @param bean - The OcProductOption.
