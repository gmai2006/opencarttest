...
public interface OcAffiliateLoginService {
    public OcAffiliateLogin find(java.lang.Integer id);

    /**
     * Select a list of OcAffiliateLogin based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcAffiliateLogin records.
     */
    public List<OcAffiliateLogin> select(int maxResult);

    /**
     * Select all OcAffiliateLogin.
     *
     * @return all OcAffiliateLogin records.
     */
    public List<OcAffiliateLogin> selectAll();

    /**
     * Create OcAffiliateLogin.
     *
     * @param bean The OcAffiliateLogin.
     * @return The OcAffiliateLogin.
     */
    public OcAffiliateLogin create(OcAffiliateLogin bean);

    /**
     * Update a OcAffiliateLogin.
     *
     * @param bean - The OcAffiliateLogin.
