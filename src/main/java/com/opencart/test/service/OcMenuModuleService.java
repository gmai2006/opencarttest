...
public interface OcMenuModuleService {
    public OcMenuModule find(java.lang.Integer id);

    /**
     * Select a list of OcMenuModule based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcMenuModule records.
     */
    public List<OcMenuModule> select(int maxResult);

    /**
     * Select all OcMenuModule.
     *
     * @return all OcMenuModule records.
     */
