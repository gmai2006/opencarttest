...
public interface OcLayoutRouteService {
    public OcLayoutRoute find(java.lang.Integer id);

    /**
     * Select a list of OcLayoutRoute based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcLayoutRoute records.
     */
    public List<OcLayoutRoute> select(int maxResult);

    /**
     * Select all OcLayoutRoute.
     *
     * @return all OcLayoutRoute records.
     */
    public List<OcLayoutRoute> selectAll();

    /**
     * Create OcLayoutRoute.
     *
     * @param bean The OcLayoutRoute.
     * @return The OcLayoutRoute.
     */
    public OcLayoutRoute create(OcLayoutRoute bean);

    /**
     * Update a OcLayoutRoute.
     *
     * @param bean - The OcLayoutRoute.
