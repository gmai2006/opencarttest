...
public interface OcCustomerOnlineService {
    public OcCustomerOnline find(java.lang.String id);

    /**
     * Select a list of OcCustomerOnline based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCustomerOnline records.
     */
    public List<OcCustomerOnline> select(int maxResult);

    /**
     * Select all OcCustomerOnline.
     *
     * @return all OcCustomerOnline records.
     */
    public List<OcCustomerOnline> selectAll();

    /**
     * Create OcCustomerOnline.
     *
     * @param bean The OcCustomerOnline.
     * @return The OcCustomerOnline.
     */
    public OcCustomerOnline create(OcCustomerOnline bean);

    /**
     * Update a OcCustomerOnline.
     *
     * @param bean - The OcCustomerOnline.
