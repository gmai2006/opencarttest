...
public interface OcAddressService {
    public OcAddress find(java.lang.Integer id);

    /**
     * Select a list of OcAddress based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcAddress records.
     */
    public List<OcAddress> select(int maxResult);

    /**
     * Select all OcAddress.
     *
     * @return all OcAddress records.
     */
