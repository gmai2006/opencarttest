...
public interface OcUploadService {
    ...
    /**
     * Select a list of OcUpload based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcUpload records.
     */
