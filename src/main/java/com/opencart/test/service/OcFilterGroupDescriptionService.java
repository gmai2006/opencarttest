...
public interface OcFilterGroupDescriptionService {
    public OcFilterGroupDescription find(OcFilterGroupDescriptionId id);
    /**
     * Select a list of OcFilterGroupDescription based on a given maximum number of returning
     * records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcFilterGroupDescription records.
     */
    public List<OcFilterGroupDescription> select(int maxResult);

    /**
     * Select all OcFilterGroupDescription.
     *
     * @return all OcFilterGroupDescription records.
     */
    public List<OcFilterGroupDescription> selectAll();

    /**
     * Create OcFilterGroupDescription.
     *
     * @param bean The OcFilterGroupDescription.
     * @return The OcFilterGroupDescription.
     */
    public OcFilterGroupDescription create(OcFilterGroupDescription bean);

    /**
     * Update a OcFilterGroupDescription.
     *
     * @param bean - The OcFilterGroupDescription.
