...
public interface OcEventService {
    public OcEvent find(java.lang.Integer id);

    /**
     * Select a list of OcEvent based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcEvent records.
     */
