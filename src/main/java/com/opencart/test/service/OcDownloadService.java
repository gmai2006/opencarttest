...
public interface OcDownloadService {
    public OcDownload find(java.lang.Integer id);

    /**
     * Select a list of OcDownload based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcDownload records.
     */
    public List<OcDownload> select(int maxResult);

    /**
     * Select all OcDownload.
     *
     * @return all OcDownload records.
     */
