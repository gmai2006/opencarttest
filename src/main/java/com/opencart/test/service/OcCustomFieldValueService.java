...
public interface OcCustomFieldValueService {
    public OcCustomFieldValue find(java.lang.Integer id);

    /**
     * Select a list of OcCustomFieldValue based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCustomFieldValue records.
     */
    public List<OcCustomFieldValue> select(int maxResult);

    /**
     * Select all OcCustomFieldValue.
     *
     * @return all OcCustomFieldValue records.
     */
    public List<OcCustomFieldValue> selectAll();

    /**
     * Create OcCustomFieldValue.
     *
     * @param bean The OcCustomFieldValue.
     * @return The OcCustomFieldValue.
     */
    public OcCustomFieldValue create(OcCustomFieldValue bean);

    /**
     * Update a OcCustomFieldValue.
     *
     * @param bean - The OcCustomFieldValue.
