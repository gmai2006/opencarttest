...
public interface OcManufacturerService {
    public OcManufacturer find(java.lang.Integer id);

    /**
     * Select a list of OcManufacturer based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcManufacturer records.
     */
    public List<OcManufacturer> select(int maxResult);

    /**
     * Select all OcManufacturer.
     *
     * @return all OcManufacturer records.
     */
    public List<OcManufacturer> selectAll();

    /**
     * Create OcManufacturer.
     *
     * @param bean The OcManufacturer.
     * @return The OcManufacturer.
     */
    public OcManufacturer create(OcManufacturer bean);

    /**
     * Update a OcManufacturer.
     *
     * @param bean - The OcManufacturer.
