...
public interface OcOrderVoucherService {
    ...
    /**
     * Select a list of OcOrderVoucher based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcOrderVoucher records.
     */
    public List<OcOrderVoucher> select(int maxResult);

    /**
     * Select all OcOrderVoucher.
     *
     * @return all OcOrderVoucher records.
     */
    public List<OcOrderVoucher> selectAll();

    /**
     * Create OcOrderVoucher.
     *
     * @param bean The OcOrderVoucher.
     * @return The OcOrderVoucher.
     */
    public OcOrderVoucher create(OcOrderVoucher bean);

    /**
     * Update a OcOrderVoucher.
     *
     * @param bean - The OcOrderVoucher.
