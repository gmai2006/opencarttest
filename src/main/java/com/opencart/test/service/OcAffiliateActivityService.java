...
public interface OcAffiliateActivityService {
    public OcAffiliateActivity find(java.lang.Integer id);

    /**
     * Select a list of OcAffiliateActivity based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcAffiliateActivity records.
     */
    public List<OcAffiliateActivity> select(int maxResult);

    /**
     * Select all OcAffiliateActivity.
     *
     * @return all OcAffiliateActivity records.
     */
    public List<OcAffiliateActivity> selectAll();

    /**
     * Create OcAffiliateActivity.
     *
     * @param bean The OcAffiliateActivity.
     * @return The OcAffiliateActivity.
     */
    public OcAffiliateActivity create(OcAffiliateActivity bean);

    /**
     * Update a OcAffiliateActivity.
     *
     * @param bean - The OcAffiliateActivity.
