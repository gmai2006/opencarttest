...
public interface OcFilterDescriptionService {
    ...
    /**
     * Select a list of OcFilterDescription based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcFilterDescription records.
     */
    public List<OcFilterDescription> select(int maxResult);

    /**
     * Select all OcFilterDescription.
     *
     * @return all OcFilterDescription records.
     */
    public List<OcFilterDescription> selectAll();

    /**
     * Create OcFilterDescription.
     *
     * @param bean The OcFilterDescription.
     * @return The OcFilterDescription.
     */
    public OcFilterDescription create(OcFilterDescription bean);

    /**
     * Update a OcFilterDescription.
     *
     * @param bean - The OcFilterDescription.
