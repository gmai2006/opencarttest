...
public interface OcProductSpecialService {
    ...
    /**
     * Select a list of OcProductSpecial based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcProductSpecial records.
     */
    public List<OcProductSpecial> select(int maxResult);

    /**
     * Select all OcProductSpecial.
     *
     * @return all OcProductSpecial records.
     */
    public List<OcProductSpecial> selectAll();

    /**
     * Create OcProductSpecial.
     *
     * @param bean The OcProductSpecial.
     * @return The OcProductSpecial.
     */
    public OcProductSpecial create(OcProductSpecial bean);

    /**
     * Update a OcProductSpecial.
     *
     * @param bean - The OcProductSpecial.
