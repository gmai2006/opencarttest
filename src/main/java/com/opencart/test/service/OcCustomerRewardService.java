...
public interface OcCustomerRewardService {
    public OcCustomerReward find(java.lang.Integer id);

    /**
     * Select a list of OcCustomerReward based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCustomerReward records.
     */
    public List<OcCustomerReward> select(int maxResult);

    /**
     * Select all OcCustomerReward.
     *
     * @return all OcCustomerReward records.
     */
    public List<OcCustomerReward> selectAll();

    /**
     * Create OcCustomerReward.
     *
     * @param bean The OcCustomerReward.
     * @return The OcCustomerReward.
     */
    public OcCustomerReward create(OcCustomerReward bean);

    /**
     * Update a OcCustomerReward.
     *
     * @param bean - The OcCustomerReward.
