...
public interface OcCustomerIpService {
    public OcCustomerIp find(java.lang.Integer id);

    /**
     * Select a list of OcCustomerIp based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCustomerIp records.
     */
    public List<OcCustomerIp> select(int maxResult);

    /**
     * Select all OcCustomerIp.
     *
     * @return all OcCustomerIp records.
     */
