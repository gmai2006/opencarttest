...
public interface OcCurrencyService {
    public OcCurrency find(java.lang.Integer id);

    /**
     * Select a list of OcCurrency based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCurrency records.
     */
    public List<OcCurrency> select(int maxResult);

    /**
     * Select all OcCurrency.
     *
     * @return all OcCurrency records.
     */
