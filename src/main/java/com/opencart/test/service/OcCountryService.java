...
public interface OcCountryService {
    public OcCountry find(java.lang.Integer id);

    /**
     * Select a list of OcCountry based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCountry records.
     */
    public List<OcCountry> select(int maxResult);

    /**
     * Select all OcCountry.
     *
     * @return all OcCountry records.
     */
