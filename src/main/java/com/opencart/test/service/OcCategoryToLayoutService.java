...
public interface OcCategoryToLayoutService {
    public OcCategoryToLayout find(OcCategoryToLayoutId id);
    /**
     * Select a list of OcCategoryToLayout based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCategoryToLayout records.
     */
    public List<OcCategoryToLayout> select(int maxResult);

    /**
     * Select all OcCategoryToLayout.
     *
     * @return all OcCategoryToLayout records.
     */
    public List<OcCategoryToLayout> selectAll();

    /**
     * Create OcCategoryToLayout.
     *
     * @param bean The OcCategoryToLayout.
     * @return The OcCategoryToLayout.
     */
    public OcCategoryToLayout create(OcCategoryToLayout bean);

    /**
     * Update a OcCategoryToLayout.
     *
     * @param bean - The OcCategoryToLayout.
