...
public interface OcCustomerActivityService {
    ...
    /**
     * Select a list of OcCustomerActivity based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCustomerActivity records.
     */
    public List<OcCustomerActivity> select(int maxResult);

    /**
     * Select all OcCustomerActivity.
     *
     * @return all OcCustomerActivity records.
     */
    public List<OcCustomerActivity> selectAll();

    /**
     * Create OcCustomerActivity.
     *
     * @param bean The OcCustomerActivity.
     * @return The OcCustomerActivity.
     */
    public OcCustomerActivity create(OcCustomerActivity bean);

    /**
     * Update a OcCustomerActivity.
     *
     * @param bean - The OcCustomerActivity.
