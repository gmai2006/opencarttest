...
public interface OcProductDiscountService {
    public OcProductDiscount find(java.lang.Integer id);

    /**
     * Select a list of OcProductDiscount based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcProductDiscount records.
     */
    public List<OcProductDiscount> select(int maxResult);

    /**
     * Select all OcProductDiscount.
     *
     * @return all OcProductDiscount records.
     */
    public List<OcProductDiscount> selectAll();

    /**
     * Create OcProductDiscount.
     *
     * @param bean The OcProductDiscount.
     * @return The OcProductDiscount.
     */
    public OcProductDiscount create(OcProductDiscount bean);

    /**
     * Update a OcProductDiscount.
     *
     * @param bean - The OcProductDiscount.
