...
public interface OcTaxRuleService {
    ...
    /**
     * Select a list of OcTaxRule based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcTaxRule records.
     */
    public List<OcTaxRule> select(int maxResult);

    /**
     * Select all OcTaxRule.
     *
     * @return all OcTaxRule records.
     */
