...
public interface OcTaxRateToCustomerGroupService {
    public OcTaxRateToCustomerGroup find(OcTaxRateToCustomerGroupId id);
    /**
     * Select a list of OcTaxRateToCustomerGroup based on a given maximum number of returning
     * records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcTaxRateToCustomerGroup records.
     */
    public List<OcTaxRateToCustomerGroup> select(int maxResult);

    /**
     * Select all OcTaxRateToCustomerGroup.
     *
     * @return all OcTaxRateToCustomerGroup records.
     */
    public List<OcTaxRateToCustomerGroup> selectAll();

    /**
     * Create OcTaxRateToCustomerGroup.
     *
     * @param bean The OcTaxRateToCustomerGroup.
     * @return The OcTaxRateToCustomerGroup.
     */
    public OcTaxRateToCustomerGroup create(OcTaxRateToCustomerGroup bean);

    /**
     * Update a OcTaxRateToCustomerGroup.
     *
     * @param bean - The OcTaxRateToCustomerGroup.
