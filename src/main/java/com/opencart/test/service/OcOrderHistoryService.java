...
public interface OcOrderHistoryService {
    public OcOrderHistory find(java.lang.Integer id);

    /**
     * Select a list of OcOrderHistory based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcOrderHistory records.
     */
    public List<OcOrderHistory> select(int maxResult);

    /**
     * Select all OcOrderHistory.
     *
     * @return all OcOrderHistory records.
     */
    public List<OcOrderHistory> selectAll();

    /**
     * Create OcOrderHistory.
     *
     * @param bean The OcOrderHistory.
     * @return The OcOrderHistory.
     */
    public OcOrderHistory create(OcOrderHistory bean);

    /**
     * Update a OcOrderHistory.
     *
     * @param bean - The OcOrderHistory.
