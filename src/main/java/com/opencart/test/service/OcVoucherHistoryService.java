...
public interface OcVoucherHistoryService {
    public OcVoucherHistory find(java.lang.Integer id);

    /**
     * Select a list of OcVoucherHistory based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcVoucherHistory records.
     */
    public List<OcVoucherHistory> select(int maxResult);

    /**
     * Select all OcVoucherHistory.
     *
     * @return all OcVoucherHistory records.
     */
    public List<OcVoucherHistory> selectAll();

    /**
     * Create OcVoucherHistory.
     *
     * @param bean The OcVoucherHistory.
     * @return The OcVoucherHistory.
     */
    public OcVoucherHistory create(OcVoucherHistory bean);

    /**
     * Update a OcVoucherHistory.
     *
     * @param bean - The OcVoucherHistory.
