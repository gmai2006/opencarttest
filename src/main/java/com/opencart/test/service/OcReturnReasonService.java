...
public interface OcReturnReasonService {
    public OcReturnReason find(OcReturnReasonId id);
    /**
     * Select a list of OcReturnReason based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcReturnReason records.
     */
    public List<OcReturnReason> select(int maxResult);

    /**
     * Select all OcReturnReason.
     *
     * @return all OcReturnReason records.
     */
    public List<OcReturnReason> selectAll();

    /**
     * Create OcReturnReason.
     *
     * @param bean The OcReturnReason.
     * @return The OcReturnReason.
     */
    public OcReturnReason create(OcReturnReason bean);

    /**
     * Update a OcReturnReason.
     *
     * @param bean - The OcReturnReason.
