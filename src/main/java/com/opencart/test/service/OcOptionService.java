...
public interface OcOptionService {
    ...
    /**
     * Select a list of OcOption based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcOption records.
     */
