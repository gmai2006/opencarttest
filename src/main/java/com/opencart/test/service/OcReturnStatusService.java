...
public interface OcReturnStatusService {
    public OcReturnStatus find(OcReturnStatusId id);
    /**
     * Select a list of OcReturnStatus based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcReturnStatus records.
     */
    public List<OcReturnStatus> select(int maxResult);

    /**
     * Select all OcReturnStatus.
     *
     * @return all OcReturnStatus records.
     */
    public List<OcReturnStatus> selectAll();

    /**
     * Create OcReturnStatus.
     *
     * @param bean The OcReturnStatus.
     * @return The OcReturnStatus.
     */
    public OcReturnStatus create(OcReturnStatus bean);

    /**
     * Update a OcReturnStatus.
     *
     * @param bean - The OcReturnStatus.
