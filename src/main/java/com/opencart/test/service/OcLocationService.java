...
public interface OcLocationService {
    public OcLocation find(java.lang.Integer id);

    /**
     * Select a list of OcLocation based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcLocation records.
     */
    public List<OcLocation> select(int maxResult);

    /**
     * Select all OcLocation.
     *
     * @return all OcLocation records.
     */
