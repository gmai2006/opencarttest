...
public interface OcReviewService {
    public OcReview find(java.lang.Integer id);

    /**
     * Select a list of OcReview based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcReview records.
     */
