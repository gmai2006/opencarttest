...
public interface OcVoucherThemeService {
    ...
    /**
     * Select a list of OcVoucherTheme based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcVoucherTheme records.
     */
    public List<OcVoucherTheme> select(int maxResult);

    /**
     * Select all OcVoucherTheme.
     *
     * @return all OcVoucherTheme records.
     */
    public List<OcVoucherTheme> selectAll();

    /**
     * Create OcVoucherTheme.
     *
     * @param bean The OcVoucherTheme.
     * @return The OcVoucherTheme.
     */
    public OcVoucherTheme create(OcVoucherTheme bean);

    /**
     * Update a OcVoucherTheme.
     *
     * @param bean - The OcVoucherTheme.
