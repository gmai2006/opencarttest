...
public interface OcOrderOptionService {
    public OcOrderOption find(java.lang.Integer id);

    /**
     * Select a list of OcOrderOption based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcOrderOption records.
     */
    public List<OcOrderOption> select(int maxResult);

    /**
     * Select all OcOrderOption.
     *
     * @return all OcOrderOption records.
     */
    public List<OcOrderOption> selectAll();

    /**
     * Create OcOrderOption.
     *
     * @param bean The OcOrderOption.
     * @return The OcOrderOption.
     */
    public OcOrderOption create(OcOrderOption bean);

    /**
     * Update a OcOrderOption.
     *
     * @param bean - The OcOrderOption.
