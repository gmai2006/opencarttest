...
public interface OcAttributeGroupDescriptionService {
    public OcAttributeGroupDescription find(OcAttributeGroupDescriptionId id);
    /**
     * Select a list of OcAttributeGroupDescription based on a given maximum number of returning
     * records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcAttributeGroupDescription records.
     */
    public List<OcAttributeGroupDescription> select(int maxResult);

    /**
     * Select all OcAttributeGroupDescription.
     *
     * @return all OcAttributeGroupDescription records.
     */
    public List<OcAttributeGroupDescription> selectAll();

    /**
     * Create OcAttributeGroupDescription.
     *
     * @param bean The OcAttributeGroupDescription.
     * @return The OcAttributeGroupDescription.
     */
    public OcAttributeGroupDescription create(OcAttributeGroupDescription bean);

    /**
     * Update a OcAttributeGroupDescription.
     *
     * @param bean - The OcAttributeGroupDescription.
