...
public interface OcOptionValueDescriptionService {
    ...
    /**
     * Select a list of OcOptionValueDescription based on a given maximum number of returning
     * records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcOptionValueDescription records.
     */
    public List<OcOptionValueDescription> select(int maxResult);

    /**
     * Select all OcOptionValueDescription.
     *
     * @return all OcOptionValueDescription records.
     */
    public List<OcOptionValueDescription> selectAll();

    /**
     * Create OcOptionValueDescription.
     *
     * @param bean The OcOptionValueDescription.
     * @return The OcOptionValueDescription.
     */
    public OcOptionValueDescription create(OcOptionValueDescription bean);

    /**
     * Update a OcOptionValueDescription.
     *
     * @param bean - The OcOptionValueDescription.
