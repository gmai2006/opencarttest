...
public interface OcCouponCategoryService {
    public OcCouponCategory find(OcCouponCategoryId id);
    /**
     * Select a list of OcCouponCategory based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCouponCategory records.
     */
    public List<OcCouponCategory> select(int maxResult);

    /**
     * Select all OcCouponCategory.
     *
     * @return all OcCouponCategory records.
     */
    public List<OcCouponCategory> selectAll();

    /**
     * Create OcCouponCategory.
     *
     * @param bean The OcCouponCategory.
     * @return The OcCouponCategory.
     */
    public OcCouponCategory create(OcCouponCategory bean);

    /**
     * Update a OcCouponCategory.
     *
     * @param bean - The OcCouponCategory.
