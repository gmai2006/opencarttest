...
public interface OcCustomerGroupDescriptionService {
    public OcCustomerGroupDescription find(OcCustomerGroupDescriptionId id);
    /**
     * Select a list of OcCustomerGroupDescription based on a given maximum number of returning
     * records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCustomerGroupDescription records.
     */
    public List<OcCustomerGroupDescription> select(int maxResult);

    /**
     * Select all OcCustomerGroupDescription.
     *
     * @return all OcCustomerGroupDescription records.
     */
    public List<OcCustomerGroupDescription> selectAll();

    /**
     * Create OcCustomerGroupDescription.
     *
     * @param bean The OcCustomerGroupDescription.
     * @return The OcCustomerGroupDescription.
     */
    public OcCustomerGroupDescription create(OcCustomerGroupDescription bean);

    /**
     * Update a OcCustomerGroupDescription.
     *
     * @param bean - The OcCustomerGroupDescription.
