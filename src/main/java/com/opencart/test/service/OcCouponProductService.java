...
public interface OcCouponProductService {
    public OcCouponProduct find(java.lang.Integer id);

    /**
     * Select a list of OcCouponProduct based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCouponProduct records.
     */
    public List<OcCouponProduct> select(int maxResult);

    /**
     * Select all OcCouponProduct.
     *
     * @return all OcCouponProduct records.
     */
    public List<OcCouponProduct> selectAll();

    /**
     * Create OcCouponProduct.
     *
     * @param bean The OcCouponProduct.
     * @return The OcCouponProduct.
     */
    public OcCouponProduct create(OcCouponProduct bean);

    /**
     * Update a OcCouponProduct.
     *
     * @param bean - The OcCouponProduct.
