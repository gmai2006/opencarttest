...
public interface OcAffiliateService {
    public OcAffiliate find(java.lang.Integer id);

    /**
     * Select a list of OcAffiliate based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcAffiliate records.
     */
    public List<OcAffiliate> select(int maxResult);

    /**
     * Select all OcAffiliate.
     *
     * @return all OcAffiliate records.
     */
