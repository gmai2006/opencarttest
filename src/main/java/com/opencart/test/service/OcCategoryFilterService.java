...
public interface OcCategoryFilterService {
    public OcCategoryFilter find(OcCategoryFilterId id);
    /**
     * Select a list of OcCategoryFilter based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCategoryFilter records.
     */
    public List<OcCategoryFilter> select(int maxResult);

    /**
     * Select all OcCategoryFilter.
     *
     * @return all OcCategoryFilter records.
     */
    public List<OcCategoryFilter> selectAll();

    /**
     * Create OcCategoryFilter.
     *
     * @param bean The OcCategoryFilter.
     * @return The OcCategoryFilter.
     */
    public OcCategoryFilter create(OcCategoryFilter bean);

    /**
     * Update a OcCategoryFilter.
     *
     * @param bean - The OcCategoryFilter.
