...
public interface OcCustomFieldCustomerGroupService {
    public OcCustomFieldCustomerGroup find(OcCustomFieldCustomerGroupId id);
    /**
     * Select a list of OcCustomFieldCustomerGroup based on a given maximum number of returning
     * records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCustomFieldCustomerGroup records.
     */
    public List<OcCustomFieldCustomerGroup> select(int maxResult);

    /**
     * Select all OcCustomFieldCustomerGroup.
     *
     * @return all OcCustomFieldCustomerGroup records.
     */
    public List<OcCustomFieldCustomerGroup> selectAll();

    /**
     * Create OcCustomFieldCustomerGroup.
     *
     * @param bean The OcCustomFieldCustomerGroup.
     * @return The OcCustomFieldCustomerGroup.
     */
    public OcCustomFieldCustomerGroup create(OcCustomFieldCustomerGroup bean);

    /**
     * Update a OcCustomFieldCustomerGroup.
     *
     * @param bean - The OcCustomFieldCustomerGroup.
