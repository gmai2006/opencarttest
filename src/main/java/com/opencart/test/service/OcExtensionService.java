...
public interface OcExtensionService {
    ...
    /**
     * Select a list of OcExtension based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcExtension records.
     */
    public List<OcExtension> select(int maxResult);

    /**
     * Select all OcExtension.
     *
     * @return all OcExtension records.
     */
