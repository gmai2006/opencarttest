...
public interface OcOrderTotalService {
    public OcOrderTotal find(java.lang.Integer id);

    /**
     * Select a list of OcOrderTotal based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcOrderTotal records.
     */
    public List<OcOrderTotal> select(int maxResult);

    /**
     * Select all OcOrderTotal.
     *
     * @return all OcOrderTotal records.
     */
