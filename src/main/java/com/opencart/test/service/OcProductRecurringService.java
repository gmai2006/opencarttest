...
public interface OcProductRecurringService {
    public OcProductRecurring find(OcProductRecurringId id);
    /**
     * Select a list of OcProductRecurring based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcProductRecurring records.
     */
    public List<OcProductRecurring> select(int maxResult);

    /**
     * Select all OcProductRecurring.
     *
     * @return all OcProductRecurring records.
     */
    public List<OcProductRecurring> selectAll();

    /**
     * Create OcProductRecurring.
     *
     * @param bean The OcProductRecurring.
     * @return The OcProductRecurring.
     */
    public OcProductRecurring create(OcProductRecurring bean);

    /**
     * Update a OcProductRecurring.
     *
     * @param bean - The OcProductRecurring.
