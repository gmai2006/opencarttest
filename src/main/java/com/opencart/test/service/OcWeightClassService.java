...
public interface OcWeightClassService {
    public OcWeightClass find(java.lang.Integer id);

    /**
     * Select a list of OcWeightClass based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcWeightClass records.
     */
    public List<OcWeightClass> select(int maxResult);

    /**
     * Select all OcWeightClass.
     *
     * @return all OcWeightClass records.
     */
    public List<OcWeightClass> selectAll();

    /**
     * Create OcWeightClass.
     *
     * @param bean The OcWeightClass.
     * @return The OcWeightClass.
     */
    public OcWeightClass create(OcWeightClass bean);

    /**
     * Update a OcWeightClass.
     *
     * @param bean - The OcWeightClass.
