...
public interface OcZoneToGeoZoneService {
    public OcZoneToGeoZone find(java.lang.Integer id);

    /**
     * Select a list of OcZoneToGeoZone based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcZoneToGeoZone records.
     */
    public List<OcZoneToGeoZone> select(int maxResult);

    /**
     * Select all OcZoneToGeoZone.
     *
     * @return all OcZoneToGeoZone records.
     */
    public List<OcZoneToGeoZone> selectAll();

    /**
     * Create OcZoneToGeoZone.
     *
     * @param bean The OcZoneToGeoZone.
     * @return The OcZoneToGeoZone.
     */
    public OcZoneToGeoZone create(OcZoneToGeoZone bean);

    /**
     * Update a OcZoneToGeoZone.
     *
     * @param bean - The OcZoneToGeoZone.
