...
public interface OcBannerImageService {
    ...
    /**
     * Select a list of OcBannerImage based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcBannerImage records.
     */
    public List<OcBannerImage> select(int maxResult);

    /**
     * Select all OcBannerImage.
     *
     * @return all OcBannerImage records.
     */
    public List<OcBannerImage> selectAll();

    /**
     * Create OcBannerImage.
     *
     * @param bean The OcBannerImage.
     * @return The OcBannerImage.
     */
    public OcBannerImage create(OcBannerImage bean);

    /**
     * Update a OcBannerImage.
     *
     * @param bean - The OcBannerImage.
