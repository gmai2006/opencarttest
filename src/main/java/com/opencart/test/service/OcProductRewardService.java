...
public interface OcProductRewardService {
    public OcProductReward find(java.lang.Integer id);

    /**
     * Select a list of OcProductReward based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcProductReward records.
     */
    public List<OcProductReward> select(int maxResult);

    /**
     * Select all OcProductReward.
     *
     * @return all OcProductReward records.
     */
    public List<OcProductReward> selectAll();

    /**
     * Create OcProductReward.
     *
     * @param bean The OcProductReward.
     * @return The OcProductReward.
     */
    public OcProductReward create(OcProductReward bean);

    /**
     * Update a OcProductReward.
     *
     * @param bean - The OcProductReward.
