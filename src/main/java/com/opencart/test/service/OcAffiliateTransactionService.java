...
public interface OcAffiliateTransactionService {
    ...
    /**
     * Select a list of OcAffiliateTransaction based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcAffiliateTransaction records.
     */
    public List<OcAffiliateTransaction> select(int maxResult);

    /**
     * Select all OcAffiliateTransaction.
     *
     * @return all OcAffiliateTransaction records.
     */
    public List<OcAffiliateTransaction> selectAll();

    /**
     * Create OcAffiliateTransaction.
     *
     * @param bean The OcAffiliateTransaction.
     * @return The OcAffiliateTransaction.
     */
    public OcAffiliateTransaction create(OcAffiliateTransaction bean);

    /**
     * Update a OcAffiliateTransaction.
     *
     * @param bean - The OcAffiliateTransaction.
