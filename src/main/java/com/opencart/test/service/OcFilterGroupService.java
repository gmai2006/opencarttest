...
public interface OcFilterGroupService {
    public OcFilterGroup find(java.lang.Integer id);

    /**
     * Select a list of OcFilterGroup based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcFilterGroup records.
     */
    public List<OcFilterGroup> select(int maxResult);

    /**
     * Select all OcFilterGroup.
     *
     * @return all OcFilterGroup records.
     */
    public List<OcFilterGroup> selectAll();

    /**
     * Create OcFilterGroup.
     *
     * @param bean The OcFilterGroup.
     * @return The OcFilterGroup.
     */
    public OcFilterGroup create(OcFilterGroup bean);

    /**
     * Update a OcFilterGroup.
     *
     * @param bean - The OcFilterGroup.
