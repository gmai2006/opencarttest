...
public interface OcProductImageService {
    ...
    /**
     * Select a list of OcProductImage based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcProductImage records.
     */
    public List<OcProductImage> select(int maxResult);

    /**
     * Select all OcProductImage.
     *
     * @return all OcProductImage records.
     */
    public List<OcProductImage> selectAll();

    /**
     * Create OcProductImage.
     *
     * @param bean The OcProductImage.
     * @return The OcProductImage.
     */
    public OcProductImage create(OcProductImage bean);

    /**
     * Update a OcProductImage.
     *
     * @param bean - The OcProductImage.
