...
public interface OcAttributeGroupService {
    public OcAttributeGroup find(java.lang.Integer id);

    /**
     * Select a list of OcAttributeGroup based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcAttributeGroup records.
     */
    public List<OcAttributeGroup> select(int maxResult);

    /**
     * Select all OcAttributeGroup.
     *
     * @return all OcAttributeGroup records.
     */
    public List<OcAttributeGroup> selectAll();

    /**
     * Create OcAttributeGroup.
     *
     * @param bean The OcAttributeGroup.
     * @return The OcAttributeGroup.
     */
    public OcAttributeGroup create(OcAttributeGroup bean);

    /**
     * Update a OcAttributeGroup.
     *
     * @param bean - The OcAttributeGroup.
