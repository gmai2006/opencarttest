...
public interface OcCouponService {
    public OcCoupon find(java.lang.Integer id);

    /**
     * Select a list of OcCoupon based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcCoupon records.
     */
