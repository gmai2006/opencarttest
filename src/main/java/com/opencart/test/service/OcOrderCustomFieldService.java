...
public interface OcOrderCustomFieldService {
    ...
    /**
     * Select a list of OcOrderCustomField based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcOrderCustomField records.
     */
    public List<OcOrderCustomField> select(int maxResult);

    /**
     * Select all OcOrderCustomField.
     *
     * @return all OcOrderCustomField records.
     */
    public List<OcOrderCustomField> selectAll();

    /**
     * Create OcOrderCustomField.
     *
     * @param bean The OcOrderCustomField.
     * @return The OcOrderCustomField.
     */
    public OcOrderCustomField create(OcOrderCustomField bean);

    /**
     * Update a OcOrderCustomField.
     *
     * @param bean - The OcOrderCustomField.
