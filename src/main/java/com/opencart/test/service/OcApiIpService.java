...
public interface OcApiIpService {
    public OcApiIp find(java.lang.Integer id);

    /**
     * Select a list of OcApiIp based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcApiIp records.
     */
