...
public interface OcWeightClassDescriptionService {
    public OcWeightClassDescription find(OcWeightClassDescriptionId id);
    /**
     * Select a list of OcWeightClassDescription based on a given maximum number of returning
     * records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcWeightClassDescription records.
     */
    public List<OcWeightClassDescription> select(int maxResult);

    /**
     * Select all OcWeightClassDescription.
     *
     * @return all OcWeightClassDescription records.
     */
    public List<OcWeightClassDescription> selectAll();

    /**
     * Create OcWeightClassDescription.
     *
     * @param bean The OcWeightClassDescription.
     * @return The OcWeightClassDescription.
     */
    public OcWeightClassDescription create(OcWeightClassDescription bean);

    /**
     * Update a OcWeightClassDescription.
     *
     * @param bean - The OcWeightClassDescription.
