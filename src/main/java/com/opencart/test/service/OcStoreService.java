...
public interface OcStoreService {
    public OcStore find(java.lang.Integer id);

    /**
     * Select a list of OcStore based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcStore records.
     */
