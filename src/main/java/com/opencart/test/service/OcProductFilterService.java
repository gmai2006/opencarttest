...
public interface OcProductFilterService {
    public OcProductFilter find(OcProductFilterId id);
    /**
     * Select a list of OcProductFilter based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcProductFilter records.
     */
    public List<OcProductFilter> select(int maxResult);

    /**
     * Select all OcProductFilter.
     *
     * @return all OcProductFilter records.
     */
    public List<OcProductFilter> selectAll();

    /**
     * Create OcProductFilter.
     *
     * @param bean The OcProductFilter.
     * @return The OcProductFilter.
     */
    public OcProductFilter create(OcProductFilter bean);

    /**
     * Update a OcProductFilter.
     *
     * @param bean - The OcProductFilter.
