...
public interface OcTranslationService {
    public OcTranslation find(java.lang.Integer id);

    /**
     * Select a list of OcTranslation based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcTranslation records.
     */
    public List<OcTranslation> select(int maxResult);

    /**
     * Select all OcTranslation.
     *
     * @return all OcTranslation records.
     */
    public List<OcTranslation> selectAll();

    /**
     * Create OcTranslation.
     *
     * @param bean The OcTranslation.
     * @return The OcTranslation.
     */
    public OcTranslation create(OcTranslation bean);

    /**
     * Update a OcTranslation.
     *
     * @param bean - The OcTranslation.
