...
public interface OcReturnHistoryService {
    public OcReturnHistory find(java.lang.Integer id);

    /**
     * Select a list of OcReturnHistory based on a given maximum number of returning records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcReturnHistory records.
     */
    public List<OcReturnHistory> select(int maxResult);

    /**
     * Select all OcReturnHistory.
     *
     * @return all OcReturnHistory records.
     */
    public List<OcReturnHistory> selectAll();

    /**
     * Create OcReturnHistory.
     *
     * @param bean The OcReturnHistory.
     * @return The OcReturnHistory.
     */
    public OcReturnHistory create(OcReturnHistory bean);

    /**
     * Update a OcReturnHistory.
     *
     * @param bean - The OcReturnHistory.
