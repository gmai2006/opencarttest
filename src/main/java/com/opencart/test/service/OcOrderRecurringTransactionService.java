...
public interface OcOrderRecurringTransactionService {
    ...
    /**
     * Select a list of OcOrderRecurringTransaction based on a given maximum number of returning
     * records.
     *
     * @param maxResult : a specified maximum number of returned records.
     * @return OcOrderRecurringTransaction records.
     */
    public List<OcOrderRecurringTransaction> select(int maxResult);

    /**
     * Select all OcOrderRecurringTransaction.
     *
     * @return all OcOrderRecurringTransaction records.
     */
    public List<OcOrderRecurringTransaction> selectAll();

    /**
     * Create OcOrderRecurringTransaction.
     *
     * @param bean The OcOrderRecurringTransaction.
     * @return The OcOrderRecurringTransaction.
     */
    public OcOrderRecurringTransaction create(OcOrderRecurringTransaction bean);

    /**
     * Update a OcOrderRecurringTransaction.
     *
     * @param bean - The OcOrderRecurringTransaction.
