...
// @Stateless
@Named("OcProductAttributeHandler")
public class OcProductAttributeHandler extends DelimiterFileHandler<OcProductAttribute> {

    @Inject
    @Named("DefaultJpaDao")
    public OcProductAttributeHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcProductAttribute parseLine(List<String> headers, List<String> tokens) {
        OcProductAttribute record = new OcProductAttribute();
