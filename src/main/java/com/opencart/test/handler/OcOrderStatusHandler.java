...
// @Stateless
@Named("OcOrderStatusHandler")
public class OcOrderStatusHandler extends DelimiterFileHandler<OcOrderStatus> {

    @Inject
    @Named("DefaultJpaDao")
    public OcOrderStatusHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcOrderStatus parseLine(List<String> headers, List<String> tokens) {
        OcOrderStatus record = new OcOrderStatus();
