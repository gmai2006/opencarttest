...
// @Stateless
@Named("OcProductOptionHandler")
public class OcProductOptionHandler extends DelimiterFileHandler<OcProductOption> {

    @Inject
    @Named("DefaultJpaDao")
    public OcProductOptionHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcProductOption parseLine(List<String> headers, List<String> tokens) {
        OcProductOption record = new OcProductOption();
