...
// @Stateless
@Named("OcProductDescriptionHandler")
public class OcProductDescriptionHandler extends DelimiterFileHandler<OcProductDescription> {

    @Inject
    @Named("DefaultJpaDao")
    public OcProductDescriptionHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcProductDescription parseLine(List<String> headers, List<String> tokens) {
        OcProductDescription record = new OcProductDescription();
