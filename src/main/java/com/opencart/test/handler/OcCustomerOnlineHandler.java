...
// @Stateless
@Named("OcCustomerOnlineHandler")
public class OcCustomerOnlineHandler extends DelimiterFileHandler<OcCustomerOnline> {

    @Inject
    @Named("DefaultJpaDao")
    public OcCustomerOnlineHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcCustomerOnline parseLine(List<String> headers, List<String> tokens) {
        OcCustomerOnline record = new OcCustomerOnline();
