...
// @Stateless
@Named("OcOptionHandler")
public class OcOptionHandler extends DelimiterFileHandler<OcOption> {

    @Inject
    @Named("DefaultJpaDao")
    public OcOptionHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcOption parseLine(List<String> headers, List<String> tokens) {
        OcOption record = new OcOption();
