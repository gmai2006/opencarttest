...
// @Stateless
@Named("OcDownloadHandler")
public class OcDownloadHandler extends DelimiterFileHandler<OcDownload> {

    @Inject
    @Named("DefaultJpaDao")
    public OcDownloadHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcDownload parseLine(List<String> headers, List<String> tokens) {
        OcDownload record = new OcDownload();
