...
// @Stateless
@Named("OcOptionValueHandler")
public class OcOptionValueHandler extends DelimiterFileHandler<OcOptionValue> {

    @Inject
    @Named("DefaultJpaDao")
    public OcOptionValueHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcOptionValue parseLine(List<String> headers, List<String> tokens) {
        OcOptionValue record = new OcOptionValue();
