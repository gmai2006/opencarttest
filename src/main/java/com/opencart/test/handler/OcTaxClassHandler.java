...
// @Stateless
@Named("OcTaxClassHandler")
public class OcTaxClassHandler extends DelimiterFileHandler<OcTaxClass> {

    @Inject
    @Named("DefaultJpaDao")
    public OcTaxClassHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcTaxClass parseLine(List<String> headers, List<String> tokens) {
        OcTaxClass record = new OcTaxClass();
