...
// @Stateless
@Named("OcReturnActionHandler")
public class OcReturnActionHandler extends DelimiterFileHandler<OcReturnAction> {

    @Inject
    @Named("DefaultJpaDao")
    public OcReturnActionHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcReturnAction parseLine(List<String> headers, List<String> tokens) {
        OcReturnAction record = new OcReturnAction();
