...
// @Stateless
@Named("OcReturnReasonHandler")
public class OcReturnReasonHandler extends DelimiterFileHandler<OcReturnReason> {

    @Inject
    @Named("DefaultJpaDao")
    public OcReturnReasonHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcReturnReason parseLine(List<String> headers, List<String> tokens) {
        OcReturnReason record = new OcReturnReason();
