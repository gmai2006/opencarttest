...
// @Stateless
@Named("OcReturnStatusHandler")
public class OcReturnStatusHandler extends DelimiterFileHandler<OcReturnStatus> {

    @Inject
    @Named("DefaultJpaDao")
    public OcReturnStatusHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcReturnStatus parseLine(List<String> headers, List<String> tokens) {
        OcReturnStatus record = new OcReturnStatus();
