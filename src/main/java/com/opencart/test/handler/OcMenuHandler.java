...
// @Stateless
@Named("OcMenuHandler")
public class OcMenuHandler extends DelimiterFileHandler<OcMenu> {

    @Inject
    @Named("DefaultJpaDao")
    public OcMenuHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcMenu parseLine(List<String> headers, List<String> tokens) {
        OcMenu record = new OcMenu();
