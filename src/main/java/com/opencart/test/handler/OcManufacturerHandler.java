...
// @Stateless
@Named("OcManufacturerHandler")
public class OcManufacturerHandler extends DelimiterFileHandler<OcManufacturer> {

    @Inject
    @Named("DefaultJpaDao")
    public OcManufacturerHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcManufacturer parseLine(List<String> headers, List<String> tokens) {
        OcManufacturer record = new OcManufacturer();
