...
// @Stateless
@Named("OcCustomerWishlistHandler")
public class OcCustomerWishlistHandler extends DelimiterFileHandler<OcCustomerWishlist> {

    @Inject
    @Named("DefaultJpaDao")
    public OcCustomerWishlistHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcCustomerWishlist parseLine(List<String> headers, List<String> tokens) {
        OcCustomerWishlist record = new OcCustomerWishlist();
