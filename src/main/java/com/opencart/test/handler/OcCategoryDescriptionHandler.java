...
// @Stateless
@Named("OcCategoryDescriptionHandler")
public class OcCategoryDescriptionHandler extends DelimiterFileHandler<OcCategoryDescription> {

    @Inject
    @Named("DefaultJpaDao")
    public OcCategoryDescriptionHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcCategoryDescription parseLine(List<String> headers, List<String> tokens) {
        OcCategoryDescription record = new OcCategoryDescription();
