...
// @Stateless
@Named("OcStockStatusHandler")
public class OcStockStatusHandler extends DelimiterFileHandler<OcStockStatus> {

    @Inject
    @Named("DefaultJpaDao")
    public OcStockStatusHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcStockStatus parseLine(List<String> headers, List<String> tokens) {
        OcStockStatus record = new OcStockStatus();
