...
// @Stateless
@Named("OcGeoZoneHandler")
public class OcGeoZoneHandler extends DelimiterFileHandler<OcGeoZone> {

    @Inject
    @Named("DefaultJpaDao")
    public OcGeoZoneHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected OcGeoZone parseLine(List<String> headers, List<String> tokens) {
        OcGeoZone record = new OcGeoZone();
