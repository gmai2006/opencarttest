...
public class OcCustomerLoginDaoTestIt {
    static final String inputFile = "OcCustomerLogin.json";
    static OcCustomerLoginDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcCustomerLoginDao(jpa);
    }
    ...
    public void testSelect() {
        OcCustomerLogin testResult = dao.find(records[1].getCustomerLoginId());
