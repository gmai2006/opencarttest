...
public class OcTaxClassDaoTestIt {
    static final String inputFile = "OcTaxClass.json";
    static OcTaxClassDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcTaxClass[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcTaxClassDao(jpa);
    }
    ...
    public void testSelect() {
        OcTaxClass testResult = dao.find(records[1].getTaxClassId());
