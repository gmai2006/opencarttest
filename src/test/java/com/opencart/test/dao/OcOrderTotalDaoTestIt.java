...
public class OcOrderTotalDaoTestIt {
    static final String inputFile = "OcOrderTotal.json";
    static OcOrderTotalDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcOrderTotal[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcOrderTotalDao(jpa);
    }
    ...
    public void testSelect() {
        OcOrderTotal testResult = dao.find(records[1].getOrderTotalId());
