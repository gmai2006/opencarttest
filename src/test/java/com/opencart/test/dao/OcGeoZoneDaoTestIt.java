...
public class OcGeoZoneDaoTestIt {
    static final String inputFile = "OcGeoZone.json";
    static OcGeoZoneDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcGeoZone[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcGeoZoneDao(jpa);
    }
    ...
    public void testSelect() {
        OcGeoZone testResult = dao.find(records[1].getGeoZoneId());
