...
public class OcMarketingDaoTestIt {
    static final String inputFile = "OcMarketing.json";
    static OcMarketingDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcMarketing[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcMarketingDao(jpa);
    }
    ...
    public void testSelect() {
        OcMarketing testResult = dao.find(records[1].getMarketingId());
        ...
        org.junit.Assert.assertTrue(
                "expect equals clicks ", this.records[1].getClicks() == testResult.getClicks());
    }
}
