...
public class OcBannerDaoTestIt {
    static final String inputFile = "OcBanner.json";
    static OcBannerDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcBanner[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcBannerDao(jpa);
    }
    ...
    public void testSelect() {
        OcBanner testResult = dao.find(records[1].getBannerId());
