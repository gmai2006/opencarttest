...
public class OcWeightClassDescriptionDaoTestIt {
    static final String inputFile = "OcWeightClassDescription.json";
    static OcWeightClassDescriptionDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcWeightClassDescriptionDao(jpa);
    }
    ...
    public void testSelect() {
        final OcWeightClassDescriptionId id =
                new OcWeightClassDescriptionId(
                        this.records[1].getWeightClassId(), this.records[1].getLanguageId());
        OcWeightClassDescription testResult = dao.find(id);
