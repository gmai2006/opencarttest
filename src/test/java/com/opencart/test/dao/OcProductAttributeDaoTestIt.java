...
public class OcProductAttributeDaoTestIt {
    static final String inputFile = "OcProductAttribute.json";
    static OcProductAttributeDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcProductAttribute[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcProductAttributeDao(jpa);
    }
    ...
    public void testSelect() {
        final OcProductAttributeId id =
                new OcProductAttributeId(
                        ...
                        this.records[1].getLanguageId());
        OcProductAttribute testResult = dao.find(id);
