...
public class OcProductSpecialDaoTestIt {
    static final String inputFile = "OcProductSpecial.json";
    static OcProductSpecialDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcProductSpecial[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcProductSpecialDao(jpa);
    }
    ...
    public void testSelect() {
        OcProductSpecial testResult = dao.find(records[1].getProductSpecialId());
