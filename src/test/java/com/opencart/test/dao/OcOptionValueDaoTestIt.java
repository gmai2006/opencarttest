...
public class OcOptionValueDaoTestIt {
    static final String inputFile = "OcOptionValue.json";
    static OcOptionValueDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcOptionValue[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcOptionValueDao(jpa);
    }
    ...
    public void testSelect() {
        OcOptionValue testResult = dao.find(records[1].getOptionValueId());
