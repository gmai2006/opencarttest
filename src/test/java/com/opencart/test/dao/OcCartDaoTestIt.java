...
public class OcCartDaoTestIt {
    static final String inputFile = "OcCart.json";
    static OcCartDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public void testSelect() {
        OcCart testResult = dao.find(records[1].getCartId());
        ...
        org.junit.Assert.assertEquals(
                "expect equals option ", this.records[1].getOption(), testResult.getOption());
        org.junit.Assert.assertTrue(
