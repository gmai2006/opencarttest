...
public class OcLanguageDaoTestIt {
    static final String inputFile = "OcLanguage.json";
    static OcLanguageDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcLanguageDao(jpa);
    }
    ...
    public void testSelect() {
        OcLanguage testResult = dao.find(records[1].getLanguageId());
        ...
        org.junit.Assert.assertEquals(
                "expect equals locale ", this.records[1].getLocale(), testResult.getLocale());
        org.junit.Assert.assertEquals(
                "expect equals image ", this.records[1].getImage(), testResult.getImage());
        org.junit.Assert.assertEquals(
                "expect equals directory ",
                this.records[1].getDirectory(),
