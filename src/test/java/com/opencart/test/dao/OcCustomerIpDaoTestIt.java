...
public class OcCustomerIpDaoTestIt {
    static final String inputFile = "OcCustomerIp.json";
    static OcCustomerIpDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcCustomerIp[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcCustomerIpDao(jpa);
    }
    ...
    public void testSelect() {
        OcCustomerIp testResult = dao.find(records[1].getCustomerIpId());
