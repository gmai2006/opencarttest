...
public class OcCustomFieldDaoTestIt {
    static final String inputFile = "OcCustomField.json";
    static OcCustomFieldDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcCustomField[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcCustomFieldDao(jpa);
    }
    ...
    public void testSelect() {
        OcCustomField testResult = dao.find(records[1].getCustomFieldId());
