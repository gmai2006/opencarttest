...
public class OcDownloadDescriptionDaoTestIt {
    static final String inputFile = "OcDownloadDescription.json";
    static OcDownloadDescriptionDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcDownloadDescription[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcDownloadDescriptionDao(jpa);
    }
    ...
    public void testSelect() {
        final OcDownloadDescriptionId id =
                new OcDownloadDescriptionId(
                        this.records[1].getLanguageId(), this.records[1].getDownloadId());
        OcDownloadDescription testResult = dao.find(id);
