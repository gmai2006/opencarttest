...
public class OcProductDiscountDaoTestIt {
    static final String inputFile = "OcProductDiscount.json";
    static OcProductDiscountDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcProductDiscount[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcProductDiscountDao(jpa);
    }
    ...
    public void testSelect() {
        OcProductDiscount testResult = dao.find(records[1].getProductDiscountId());
