...
public class OcCurrencyDaoTestIt {
    static final String inputFile = "OcCurrency.json";
    static OcCurrencyDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcCurrency[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcCurrencyDao(jpa);
    }
    ...
    public void testSelect() {
        OcCurrency testResult = dao.find(records[1].getCurrencyId());
