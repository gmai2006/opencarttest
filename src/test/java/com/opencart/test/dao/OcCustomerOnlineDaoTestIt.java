...
public class OcCustomerOnlineDaoTestIt {
    static final String inputFile = "OcCustomerOnline.json";
    static OcCustomerOnlineDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcCustomerOnline[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcCustomerOnlineDao(jpa);
    }
    ...
    public void testSelect() {
        OcCustomerOnline testResult = dao.find(records[1].getIp());
