...
public class OcAffiliateLoginDaoTestIt {
    static final String inputFile = "OcAffiliateLogin.json";
    static OcAffiliateLoginDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcAffiliateLoginDao(jpa);
    }
    ...
    public void testSelect() {
        OcAffiliateLogin testResult = dao.find(records[1].getAffiliateLoginId());
