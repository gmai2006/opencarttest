...
public class OcOrderHistoryDaoTestIt {
    static final String inputFile = "OcOrderHistory.json";
    static OcOrderHistoryDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcOrderHistoryDao(jpa);
    }
    ...
    public void testSelect() {
        OcOrderHistory testResult = dao.find(records[1].getOrderHistoryId());
