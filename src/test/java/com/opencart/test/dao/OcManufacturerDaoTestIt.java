...
public class OcManufacturerDaoTestIt {
    static final String inputFile = "OcManufacturer.json";
    static OcManufacturerDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcManufacturer[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcManufacturerDao(jpa);
    }
    ...
    public void testSelect() {
        OcManufacturer testResult = dao.find(records[1].getManufacturerId());
