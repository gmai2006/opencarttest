...
public class OcProductImageDaoTestIt {
    static final String inputFile = "OcProductImage.json";
    static OcProductImageDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcProductImage[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcProductImageDao(jpa);
    }
    ...
    public void testSelect() {
        OcProductImage testResult = dao.find(records[1].getProductImageId());
