...
public class OcProductOptionValueDaoTestIt {
    static final String inputFile = "OcProductOptionValue.json";
    static OcProductOptionValueDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcProductOptionValue[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcProductOptionValueDao(jpa);
    }
    ...
    public void testSelect() {
        OcProductOptionValue testResult = dao.find(records[1].getProductOptionValueId());
        assertNotNull("expect result", testResult);
        org.junit.Assert.assertTrue(
                "expect equals productOptionId ",
                this.records[1].getProductOptionId() == testResult.getProductOptionId());
        org.junit.Assert.assertTrue(
        ...
        org.junit.Assert.assertTrue(
                ...
                this.records[1].getOptionValueId() == testResult.getOptionValueId());
        org.junit.Assert.assertTrue(
