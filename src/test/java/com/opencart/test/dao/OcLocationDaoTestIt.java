...
public class OcLocationDaoTestIt {
    static final String inputFile = "OcLocation.json";
    static OcLocationDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcLocationDao(jpa);
    }
    ...
    public void testSelect() {
        OcLocation testResult = dao.find(records[1].getLocationId());
        ...
        org.junit.Assert.assertEquals(
                "expect equals geocode ", this.records[1].getGeocode(), testResult.getGeocode());
        org.junit.Assert.assertEquals(
                "expect equals image ", this.records[1].getImage(), testResult.getImage());
        org.junit.Assert.assertEquals(
                "expect equals open ", this.records[1].getOpen(), testResult.getOpen());
        org.junit.Assert.assertEquals(
