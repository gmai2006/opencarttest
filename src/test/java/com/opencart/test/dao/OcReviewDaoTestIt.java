...
public class OcReviewDaoTestIt {
    static final String inputFile = "OcReview.json";
    static OcReviewDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcReviewDao(jpa);
    }
    ...
    public void testSelect() {
        OcReview testResult = dao.find(records[1].getReviewId());
        ...
        org.junit.Assert.assertEquals(
                "expect equals author ", this.records[1].getAuthor(), testResult.getAuthor());
        org.junit.Assert.assertEquals(
                "expect equals text ", this.records[1].getText(), testResult.getText());
        org.junit.Assert.assertTrue(
                "expect equals rating ", this.records[1].getRating() == testResult.getRating());
        org.junit.Assert.assertTrue(
