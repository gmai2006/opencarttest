...
public class OcLayoutModuleDaoTestIt {
    static final String inputFile = "OcLayoutModule.json";
    static OcLayoutModuleDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcLayoutModuleDao(jpa);
    }
    ...
    public void testSelect() {
        OcLayoutModule testResult = dao.find(records[1].getLayoutModuleId());
