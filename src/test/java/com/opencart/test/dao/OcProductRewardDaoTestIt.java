...
public class OcProductRewardDaoTestIt {
    static final String inputFile = "OcProductReward.json";
    static OcProductRewardDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcProductReward[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcProductRewardDao(jpa);
    }
    ...
    public void testSelect() {
        OcProductReward testResult = dao.find(records[1].getProductRewardId());
