...
public class OcCountryDaoTestIt {
    static final String inputFile = "OcCountry.json";
    static OcCountryDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcCountryDao(jpa);
    }
    ...
    public void testSelect() {
        OcCountry testResult = dao.find(records[1].getCountryId());
        assertNotNull("expect result", testResult);
        org.junit.Assert.assertEquals(
                "expect equals name ", this.records[1].getName(), testResult.getName());
        org.junit.Assert.assertEquals(
                "expect equals isoCode2 ", this.records[1].getIsoCode2(), testResult.getIsoCode2());
        org.junit.Assert.assertEquals(
                "expect equals isoCode3 ", this.records[1].getIsoCode3(), testResult.getIsoCode3());
        org.junit.Assert.assertEquals(
                "expect equals addressFormat ",
                this.records[1].getAddressFormat(),
                testResult.getAddressFormat());
        org.junit.Assert.assertTrue(
                "expect equals postcodeRequired ",
                this.records[1].getPostcodeRequired() == testResult.getPostcodeRequired());
        org.junit.Assert.assertTrue(
