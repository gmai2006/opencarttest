...
public class OcProductDescriptionDaoTestIt {
    static final String inputFile = "OcProductDescription.json";
    static OcProductDescriptionDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcProductDescriptionDao(jpa);
    }
    ...
    public void testSelect() {
        final OcProductDescriptionId id =
                new OcProductDescriptionId(
                        this.records[1].getProductId(), this.records[1].getLanguageId());
        OcProductDescription testResult = dao.find(id);
        ...
        org.junit.Assert.assertEquals(
                "expect equals tag ", this.records[1].getTag(), testResult.getTag());
        org.junit.Assert.assertEquals(
