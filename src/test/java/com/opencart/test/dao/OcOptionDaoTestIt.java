...
public class OcOptionDaoTestIt {
    static final String inputFile = "OcOption.json";
    static OcOptionDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcOption[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcOptionDao(jpa);
    }
    ...
    public void testSelect() {
        OcOption testResult = dao.find(records[1].getOptionId());
