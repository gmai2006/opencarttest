...
public class OcOrderProductDaoTestIt {
    static final String inputFile = "OcOrderProduct.json";
    static OcOrderProductDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcOrderProduct[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcOrderProductDao(jpa);
    }
    ...
    public void testSelect() {
        OcOrderProduct testResult = dao.find(records[1].getOrderProductId());
        ...
        org.junit.Assert.assertTrue(
                "expect equals reward ", this.records[1].getReward() == testResult.getReward());
    }
}
