...
public class OcModuleDaoTestIt {
    static final String inputFile = "OcModule.json";
    static OcModuleDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcModule[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcModuleDao(jpa);
    }
    ...
    public void testSelect() {
        OcModule testResult = dao.find(records[1].getModuleId());
        ...
        org.junit.Assert.assertEquals(
                "expect equals setting ", this.records[1].getSetting(), testResult.getSetting());
    }
}
