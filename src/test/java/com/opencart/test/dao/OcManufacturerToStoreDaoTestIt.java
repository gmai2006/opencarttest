...
public class OcManufacturerToStoreDaoTestIt {
    static final String inputFile = "OcManufacturerToStore.json";
    static OcManufacturerToStoreDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcManufacturerToStore[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcManufacturerToStoreDao(jpa);
    }
    ...
    public void testSelect() {
        final OcManufacturerToStoreId id =
                new OcManufacturerToStoreId(
                        this.records[1].getStoreId(), this.records[1].getManufacturerId());
        OcManufacturerToStore testResult = dao.find(id);
