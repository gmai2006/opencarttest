...
public class OcCategoryDescriptionDaoTestIt {
    static final String inputFile = "OcCategoryDescription.json";
    static OcCategoryDescriptionDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcCategoryDescription[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcCategoryDescriptionDao(jpa);
    }
    ...
    public void before() {
        try {
            ...
            records = gson.fromJson(json, OcCategoryDescription[].class);
            json = null;
    ...
    public void testSelect() {
        final OcCategoryDescriptionId id =
                new OcCategoryDescriptionId(
                        this.records[1].getCategoryId(), this.records[1].getLanguageId());
        OcCategoryDescription testResult = dao.find(id);
