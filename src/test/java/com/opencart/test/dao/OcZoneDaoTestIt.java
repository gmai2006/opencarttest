...
public class OcZoneDaoTestIt {
    static final String inputFile = "OcZone.json";
    static OcZoneDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcZone[] records;
    ...
    public void testSelect() {
        OcZone testResult = dao.find(records[1].getZoneId());
