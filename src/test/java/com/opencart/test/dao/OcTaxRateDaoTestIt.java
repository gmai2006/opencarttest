...
public class OcTaxRateDaoTestIt {
    static final String inputFile = "OcTaxRate.json";
    static OcTaxRateDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcTaxRate[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcTaxRateDao(jpa);
    }
    ...
    public void testSelect() {
        OcTaxRate testResult = dao.find(records[1].getTaxRateId());
