...
public class OcVoucherThemeDescriptionDaoTestIt {
    static final String inputFile = "OcVoucherThemeDescription.json";
    static OcVoucherThemeDescriptionDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcVoucherThemeDescription[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcVoucherThemeDescriptionDao(jpa);
    }
    ...
    public void testSelect() {
        final OcVoucherThemeDescriptionId id =
                new OcVoucherThemeDescriptionId(
                        this.records[1].getVoucherThemeId(), this.records[1].getLanguageId());
        OcVoucherThemeDescription testResult = dao.find(id);
