...
public class OcLengthClassDescriptionDaoTestIt {
    static final String inputFile = "OcLengthClassDescription.json";
    static OcLengthClassDescriptionDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcLengthClassDescriptionDao(jpa);
    }
    ...
    public void testSelect() {
        final OcLengthClassDescriptionId id =
                new OcLengthClassDescriptionId(
                        this.records[1].getLengthClassId(), this.records[1].getLanguageId());
        OcLengthClassDescription testResult = dao.find(id);
        assertNotNull("expect result", testResult);
        org.junit.Assert.assertEquals(
                "expect equals title ", this.records[1].getTitle(), testResult.getTitle());
        org.junit.Assert.assertEquals(
                "expect equals unit ", this.records[1].getUnit(), testResult.getUnit());
    }
}
