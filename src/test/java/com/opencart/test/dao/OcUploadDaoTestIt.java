...
public class OcUploadDaoTestIt {
    static final String inputFile = "OcUpload.json";
    static OcUploadDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcUpload[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcUploadDao(jpa);
    }
    ...
    public void testSelect() {
        OcUpload testResult = dao.find(records[1].getUploadId());
