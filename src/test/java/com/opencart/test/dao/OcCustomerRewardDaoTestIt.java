...
public class OcCustomerRewardDaoTestIt {
    static final String inputFile = "OcCustomerReward.json";
    static OcCustomerRewardDao dao;
    static Gson gson =
            new GsonBuilder()
                    .registerTypeHierarchyAdapter(byte[].class, new ByteArrayToBase64TypeAdapter())
                    .setDateFormat("yyyy-MM-dd HH:mm:ss.S")
                    .create();
    private OcCustomerReward[] records;
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcCustomerRewardDao(jpa);
    }
    ...
    public void testSelect() {
        OcCustomerReward testResult = dao.find(records[1].getCustomerRewardId());
