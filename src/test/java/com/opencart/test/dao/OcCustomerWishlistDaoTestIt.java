...
public class OcCustomerWishlistDaoTestIt {
    static final String inputFile = "OcCustomerWishlist.json";
    static OcCustomerWishlistDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultOcCustomerWishlistDao(jpa);
    }
    ...
    public void testSelect() {
        final OcCustomerWishlistId id =
                new OcCustomerWishlistId(
                        this.records[1].getProductId(), this.records[1].getCustomerId());
        OcCustomerWishlist testResult = dao.find(id);
