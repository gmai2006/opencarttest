...
public class OcMarketingHandlerTestIt {
    static final String inputFile = "OcMarketing.json";
    static OcMarketingHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcMarketing testResult = jpa.find(OcMarketing.class, records[0].getMarketingId());
        ...
        org.junit.Assert.assertEquals(
                "expect equals clicks ", this.records[0].getClicks(), testResult.getClicks());
