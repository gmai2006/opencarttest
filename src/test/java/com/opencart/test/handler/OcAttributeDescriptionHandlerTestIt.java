...
public class OcAttributeDescriptionHandlerTestIt {
    static final String inputFile = "OcAttributeDescription.json";
    static OcAttributeDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcAttributeDescriptionId id =
                new OcAttributeDescriptionId(
                        this.records[0].getAttributeId(), this.records[0].getLanguageId());
        OcAttributeDescription testResult = jpa.find(OcAttributeDescription.class, id);
