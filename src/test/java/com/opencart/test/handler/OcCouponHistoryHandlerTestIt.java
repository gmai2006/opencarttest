...
public class OcCouponHistoryHandlerTestIt {
    static final String inputFile = "OcCouponHistory.json";
    static OcCouponHistoryHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcCouponHistory[] records;
    ...
    public void testSelect() throws IOException {
        ...
        OcCouponHistory testResult =
                jpa.find(OcCouponHistory.class, records[0].getCouponHistoryId());
        org.junit.Assert.assertEquals(
                "expect equals couponId ", this.records[0].getCouponId(), testResult.getCouponId());
        org.junit.Assert.assertEquals(
