...
public class OcFilterGroupHandlerTestIt {
    static final String inputFile = "OcFilterGroup.json";
    static OcFilterGroupHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcFilterGroup testResult = jpa.find(OcFilterGroup.class, records[0].getFilterGroupId());
