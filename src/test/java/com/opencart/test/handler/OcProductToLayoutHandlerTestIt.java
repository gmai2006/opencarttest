...
public class OcProductToLayoutHandlerTestIt {
    static final String inputFile = "OcProductToLayout.json";
    static OcProductToLayoutHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcProductToLayout[] records;
    ...
    public void testSelect() throws IOException {
        ...
        records = gson.fromJson(json, OcProductToLayout[].class);
        assertEquals("match count", count, records.length);
        final OcProductToLayoutId id =
                new OcProductToLayoutId(
                        this.records[0].getStoreId(), this.records[0].getProductId());
        OcProductToLayout testResult = jpa.find(OcProductToLayout.class, id);
