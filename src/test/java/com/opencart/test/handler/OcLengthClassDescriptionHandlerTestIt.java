...
public class OcLengthClassDescriptionHandlerTestIt {
    static final String inputFile = "OcLengthClassDescription.json";
    static OcLengthClassDescriptionHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcLengthClassDescription[] records;
    ...
    public void testSelect() throws IOException {
        ...
        final OcLengthClassDescriptionId id =
                new OcLengthClassDescriptionId(
                        this.records[0].getLengthClassId(), this.records[0].getLanguageId());
        OcLengthClassDescription testResult = jpa.find(OcLengthClassDescription.class, id);
