...
public class OcCurrencyHandlerTestIt {
    static final String inputFile = "OcCurrency.json";
    static OcCurrencyHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcCurrency testResult = jpa.find(OcCurrency.class, records[0].getCurrencyId());
