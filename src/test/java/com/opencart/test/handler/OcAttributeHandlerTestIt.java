...
public class OcAttributeHandlerTestIt {
    static final String inputFile = "OcAttribute.json";
    static OcAttributeHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcAttribute testResult = jpa.find(OcAttribute.class, records[0].getAttributeId());
        org.junit.Assert.assertEquals(
                "expect equals attributeGroupId ",
                this.records[0].getAttributeGroupId(),
                testResult.getAttributeGroupId());
        org.junit.Assert.assertEquals(
