...
public class OcProductDiscountHandlerTestIt {
    static final String inputFile = "OcProductDiscount.json";
    static OcProductDiscountHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcProductDiscount testResult =
                jpa.find(OcProductDiscount.class, records[0].getProductDiscountId());
