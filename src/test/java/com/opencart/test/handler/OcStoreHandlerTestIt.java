...
public class OcStoreHandlerTestIt {
    static final String inputFile = "OcStore.json";
    static OcStoreHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcStore testResult = jpa.find(OcStore.class, records[0].getStoreId());
        ...
        assertEquals("expect equals ssl ", this.records[0].getSsl(), testResult.getSsl());
