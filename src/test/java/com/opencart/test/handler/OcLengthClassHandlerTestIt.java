...
public class OcLengthClassHandlerTestIt {
    static final String inputFile = "OcLengthClass.json";
    static OcLengthClassHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcLengthClass testResult = jpa.find(OcLengthClass.class, records[0].getLengthClassId());
