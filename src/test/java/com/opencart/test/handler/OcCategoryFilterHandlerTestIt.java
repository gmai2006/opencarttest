...
public class OcCategoryFilterHandlerTestIt {
    static final String inputFile = "OcCategoryFilter.json";
    static OcCategoryFilterHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcCategoryFilterId id =
                new OcCategoryFilterId(
                        this.records[0].getCategoryId(), this.records[0].getFilterId());
        OcCategoryFilter testResult = jpa.find(OcCategoryFilter.class, id);
