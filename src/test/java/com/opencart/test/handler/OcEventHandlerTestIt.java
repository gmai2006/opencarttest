...
public class OcEventHandlerTestIt {
    static final String inputFile = "OcEvent.json";
    static OcEventHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcEvent testResult = jpa.find(OcEvent.class, records[0].getEventId());
        assertEquals("expect equals code ", this.records[0].getCode(), testResult.getCode());
        assertEquals(
                "expect equals trigger ", this.records[0].getTrigger(), testResult.getTrigger());
