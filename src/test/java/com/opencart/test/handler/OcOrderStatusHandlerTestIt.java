...
public class OcOrderStatusHandlerTestIt {
    static final String inputFile = "OcOrderStatus.json";
    static OcOrderStatusHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcOrderStatusId id =
                new OcOrderStatusId(
                        this.records[0].getOrderStatusId(), this.records[0].getLanguageId());
        OcOrderStatus testResult = jpa.find(OcOrderStatus.class, id);
