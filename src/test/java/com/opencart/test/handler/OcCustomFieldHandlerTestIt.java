...
public class OcCustomFieldHandlerTestIt {
    static final String inputFile = "OcCustomField.json";
    static OcCustomFieldHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcCustomField testResult = jpa.find(OcCustomField.class, records[0].getCustomFieldId());
