...
public class OcInformationToStoreHandlerTestIt {
    static final String inputFile = "OcInformationToStore.json";
    static OcInformationToStoreHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcInformationToStoreId id =
                new OcInformationToStoreId(
                        this.records[0].getInformationId(), this.records[0].getStoreId());
        OcInformationToStore testResult = jpa.find(OcInformationToStore.class, id);
