...
public class OcApiSessionHandlerTestIt {
    static final String inputFile = "OcApiSession.json";
    static OcApiSessionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcApiSession testResult = jpa.find(OcApiSession.class, records[0].getApiSessionId());
