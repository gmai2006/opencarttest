...
public class OcCustomerGroupDescriptionHandlerTestIt {
    static final String inputFile = "OcCustomerGroupDescription.json";
    static OcCustomerGroupDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcCustomerGroupDescriptionId id =
                new OcCustomerGroupDescriptionId(
                        this.records[0].getLanguageId(), this.records[0].getCustomerGroupId());
        OcCustomerGroupDescription testResult = jpa.find(OcCustomerGroupDescription.class, id);
