...
public class OcCartHandlerTestIt {
    static final String inputFile = "OcCart.json";
    static OcCartHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcCart testResult = jpa.find(OcCart.class, records[0].getCartId());
        org.junit.Assert.assertEquals(
                "expect equals apiId ", this.records[0].getApiId(), testResult.getApiId());
        org.junit.Assert.assertEquals(
        ...
        assertEquals("expect equals option ", this.records[0].getOption(), testResult.getOption());
        org.junit.Assert.assertEquals(
