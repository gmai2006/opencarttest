...
public class OcOrderOptionHandlerTestIt {
    static final String inputFile = "OcOrderOption.json";
    static OcOrderOptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcOrderOption testResult = jpa.find(OcOrderOption.class, records[0].getOrderOptionId());
        org.junit.Assert.assertEquals(
                "expect equals orderId ", this.records[0].getOrderId(), testResult.getOrderId());
        org.junit.Assert.assertEquals(
                "expect equals orderProductId ",
                this.records[0].getOrderProductId(),
                testResult.getOrderProductId());
        org.junit.Assert.assertEquals(
        ...
        org.junit.Assert.assertEquals(
                ...
                this.records[0].getProductOptionValueId(),
                testResult.getProductOptionValueId());
