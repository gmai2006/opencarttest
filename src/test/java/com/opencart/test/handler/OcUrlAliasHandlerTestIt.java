...
public class OcUrlAliasHandlerTestIt {
    static final String inputFile = "OcUrlAlias.json";
    static OcUrlAliasHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcUrlAlias testResult = jpa.find(OcUrlAlias.class, records[0].getUrlAliasId());
        assertEquals("expect equals query ", this.records[0].getQuery(), testResult.getQuery());
        assertEquals(
                "expect equals keyword ", this.records[0].getKeyword(), testResult.getKeyword());
