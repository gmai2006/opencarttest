...
public class OcModificationHandlerTestIt {
    static final String inputFile = "OcModification.json";
    static OcModificationHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcModification[] records;
    ...
    public void testSelect() throws IOException {
        ...
        OcModification testResult = jpa.find(OcModification.class, records[0].getModificationId());
