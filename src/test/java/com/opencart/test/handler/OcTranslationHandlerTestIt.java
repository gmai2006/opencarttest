...
public class OcTranslationHandlerTestIt {
    static final String inputFile = "OcTranslation.json";
    static OcTranslationHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        records = gson.fromJson(json, OcTranslation[].class);
        assertEquals("match count", count, records.length);
        OcTranslation testResult = jpa.find(OcTranslation.class, records[0].getTranslationId());
        ...
        assertEquals("expect equals key ", this.records[0].getKey(), testResult.getKey());
