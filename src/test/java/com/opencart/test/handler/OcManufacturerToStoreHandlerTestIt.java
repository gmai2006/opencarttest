...
public class OcManufacturerToStoreHandlerTestIt {
    static final String inputFile = "OcManufacturerToStore.json";
    static OcManufacturerToStoreHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcManufacturerToStoreId id =
                new OcManufacturerToStoreId(
                        this.records[0].getStoreId(), this.records[0].getManufacturerId());
        OcManufacturerToStore testResult = jpa.find(OcManufacturerToStore.class, id);
