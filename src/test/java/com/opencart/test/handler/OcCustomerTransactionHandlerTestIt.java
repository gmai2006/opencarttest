...
public class OcCustomerTransactionHandlerTestIt {
    static final String inputFile = "OcCustomerTransaction.json";
    static OcCustomerTransactionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcCustomerTransaction testResult =
                jpa.find(OcCustomerTransaction.class, records[0].getCustomerTransactionId());
