...
public class OcCustomerHistoryHandlerTestIt {
    static final String inputFile = "OcCustomerHistory.json";
    static OcCustomerHistoryHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcCustomerHistory testResult =
                jpa.find(OcCustomerHistory.class, records[0].getCustomerHistoryId());
