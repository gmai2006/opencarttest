...
public class OcDownloadHandlerTestIt {
    static final String inputFile = "OcDownload.json";
    static OcDownloadHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcDownload testResult = jpa.find(OcDownload.class, records[0].getDownloadId());
        assertEquals(
                "expect equals filename ", this.records[0].getFilename(), testResult.getFilename());
        assertEquals("expect equals mask ", this.records[0].getMask(), testResult.getMask());
