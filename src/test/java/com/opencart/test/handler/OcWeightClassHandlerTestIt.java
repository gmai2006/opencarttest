...
public class OcWeightClassHandlerTestIt {
    static final String inputFile = "OcWeightClass.json";
    static OcWeightClassHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcWeightClass testResult = jpa.find(OcWeightClass.class, records[0].getWeightClassId());
