...
public class OcVoucherHandlerTestIt {
    static final String inputFile = "OcVoucher.json";
    static OcVoucherHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcVoucher testResult = jpa.find(OcVoucher.class, records[0].getVoucherId());
