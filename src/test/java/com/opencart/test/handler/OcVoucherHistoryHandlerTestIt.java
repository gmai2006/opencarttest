...
public class OcVoucherHistoryHandlerTestIt {
    static final String inputFile = "OcVoucherHistory.json";
    static OcVoucherHistoryHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcVoucherHistory testResult =
                jpa.find(OcVoucherHistory.class, records[0].getVoucherHistoryId());
