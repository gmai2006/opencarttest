...
public class OcInformationToLayoutHandlerTestIt {
    static final String inputFile = "OcInformationToLayout.json";
    static OcInformationToLayoutHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcInformationToLayout[] records;
    ...
    public void testSelect() throws IOException {
        ...
        final OcInformationToLayoutId id =
                new OcInformationToLayoutId(
                        this.records[0].getInformationId(), this.records[0].getStoreId());
        OcInformationToLayout testResult = jpa.find(OcInformationToLayout.class, id);
