...
public class OcMenuDescriptionHandlerTestIt {
    static final String inputFile = "OcMenuDescription.json";
    static OcMenuDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcMenuDescriptionId id =
                new OcMenuDescriptionId(
                        this.records[0].getLanguageId(), this.records[0].getMenuId());
        OcMenuDescription testResult = jpa.find(OcMenuDescription.class, id);
