...
public class OcOptionValueHandlerTestIt {
    static final String inputFile = "OcOptionValue.json";
    static OcOptionValueHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcOptionValue testResult = jpa.find(OcOptionValue.class, records[0].getOptionValueId());
