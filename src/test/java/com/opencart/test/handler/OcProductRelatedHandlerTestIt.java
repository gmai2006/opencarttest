...
public class OcProductRelatedHandlerTestIt {
    static final String inputFile = "OcProductRelated.json";
    static OcProductRelatedHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcProductRelatedId id =
                new OcProductRelatedId(
                        this.records[0].getRelatedId(), this.records[0].getProductId());
        OcProductRelated testResult = jpa.find(OcProductRelated.class, id);
