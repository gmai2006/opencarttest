...
public class OcLayoutModuleHandlerTestIt {
    static final String inputFile = "OcLayoutModule.json";
    static OcLayoutModuleHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcLayoutModule[] records;
    ...
    public void testSelect() throws IOException {
        ...
        OcLayoutModule testResult = jpa.find(OcLayoutModule.class, records[0].getLayoutModuleId());
