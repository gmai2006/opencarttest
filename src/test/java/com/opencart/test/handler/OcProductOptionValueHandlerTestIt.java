...
public class OcProductOptionValueHandlerTestIt {
    static final String inputFile = "OcProductOptionValue.json";
    static OcProductOptionValueHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcProductOptionValue testResult =
                jpa.find(OcProductOptionValue.class, records[0].getProductOptionValueId());
        org.junit.Assert.assertEquals(
                "expect equals productOptionId ",
                this.records[0].getProductOptionId(),
                testResult.getProductOptionId());
        org.junit.Assert.assertEquals(
        ...
        org.junit.Assert.assertEquals(
                ...
                this.records[0].getOptionValueId(),
                testResult.getOptionValueId());
        org.junit.Assert.assertEquals(
        ...
        assertEquals(
                ...
                this.records[0].getWeightPrefix(),
