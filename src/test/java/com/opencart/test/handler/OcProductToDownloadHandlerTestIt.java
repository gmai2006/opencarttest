...
public class OcProductToDownloadHandlerTestIt {
    static final String inputFile = "OcProductToDownload.json";
    static OcProductToDownloadHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcProductToDownloadId id =
                new OcProductToDownloadId(
                        this.records[0].getProductId(), this.records[0].getDownloadId());
        OcProductToDownload testResult = jpa.find(OcProductToDownload.class, id);
