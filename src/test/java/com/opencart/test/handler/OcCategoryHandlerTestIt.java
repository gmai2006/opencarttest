...
public class OcCategoryHandlerTestIt {
    static final String inputFile = "OcCategory.json";
    static OcCategoryHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcCategory testResult = jpa.find(OcCategory.class, records[0].getCategoryId());
        ...
        org.junit.Assert.assertEquals(
                "expect equals top ", this.records[0].getTop(), testResult.getTop());
        org.junit.Assert.assertEquals(
                "expect equals column ", this.records[0].getColumn(), testResult.getColumn());
        org.junit.Assert.assertEquals(
