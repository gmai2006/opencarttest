...
public class OcCustomFieldDescriptionHandlerTestIt {
    static final String inputFile = "OcCustomFieldDescription.json";
    static OcCustomFieldDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcCustomFieldDescriptionId id =
                new OcCustomFieldDescriptionId(
                        this.records[0].getCustomFieldId(), this.records[0].getLanguageId());
        OcCustomFieldDescription testResult = jpa.find(OcCustomFieldDescription.class, id);
