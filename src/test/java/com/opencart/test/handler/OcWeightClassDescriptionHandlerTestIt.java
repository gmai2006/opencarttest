...
public class OcWeightClassDescriptionHandlerTestIt {
    static final String inputFile = "OcWeightClassDescription.json";
    static OcWeightClassDescriptionHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcWeightClassDescription[] records;
    ...
    public void testSelect() throws IOException {
        ...
        final OcWeightClassDescriptionId id =
                new OcWeightClassDescriptionId(
                        this.records[0].getWeightClassId(), this.records[0].getLanguageId());
        OcWeightClassDescription testResult = jpa.find(OcWeightClassDescription.class, id);
        assertEquals("expect equals title ", this.records[0].getTitle(), testResult.getTitle());
        assertEquals("expect equals unit ", this.records[0].getUnit(), testResult.getUnit());
