...
public class OcVoucherThemeHandlerTestIt {
    static final String inputFile = "OcVoucherTheme.json";
    static OcVoucherThemeHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcVoucherTheme testResult = jpa.find(OcVoucherTheme.class, records[0].getVoucherThemeId());
