...
public class OcCategoryToLayoutHandlerTestIt {
    static final String inputFile = "OcCategoryToLayout.json";
    static OcCategoryToLayoutHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcCategoryToLayout[] records;
    ...
    public void testSelect() throws IOException {
        ...
        records = gson.fromJson(json, OcCategoryToLayout[].class);
        assertEquals("match count", count, records.length);
        final OcCategoryToLayoutId id =
                new OcCategoryToLayoutId(
                        this.records[0].getStoreId(), this.records[0].getCategoryId());
        OcCategoryToLayout testResult = jpa.find(OcCategoryToLayout.class, id);
        org.junit.Assert.assertEquals(
                "expect equals layoutId ", this.records[0].getLayoutId(), testResult.getLayoutId());
