...
public class OcAffiliateTransactionHandlerTestIt {
    static final String inputFile = "OcAffiliateTransaction.json";
    static OcAffiliateTransactionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcAffiliateTransaction testResult =
                jpa.find(OcAffiliateTransaction.class, records[0].getAffiliateTransactionId());
