...
public class OcProductSpecialHandlerTestIt {
    static final String inputFile = "OcProductSpecial.json";
    static OcProductSpecialHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcProductSpecial testResult =
                jpa.find(OcProductSpecial.class, records[0].getProductSpecialId());
