...
public class OcProductRewardHandlerTestIt {
    static final String inputFile = "OcProductReward.json";
    static OcProductRewardHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcProductReward testResult =
                jpa.find(OcProductReward.class, records[0].getProductRewardId());
