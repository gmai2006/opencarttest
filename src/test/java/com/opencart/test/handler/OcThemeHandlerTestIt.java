...
public class OcThemeHandlerTestIt {
    static final String inputFile = "OcTheme.json";
    static OcThemeHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcTheme testResult = jpa.find(OcTheme.class, records[0].getThemeId());
        org.junit.Assert.assertEquals(
                "expect equals storeId ", this.records[0].getStoreId(), testResult.getStoreId());
        assertEquals("expect equals theme ", this.records[0].getTheme(), testResult.getTheme());
