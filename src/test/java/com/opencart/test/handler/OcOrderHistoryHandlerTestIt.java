...
public class OcOrderHistoryHandlerTestIt {
    static final String inputFile = "OcOrderHistory.json";
    static OcOrderHistoryHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcOrderHistory[] records;
    ...
    public void testSelect() throws IOException {
        ...
        OcOrderHistory testResult = jpa.find(OcOrderHistory.class, records[0].getOrderHistoryId());
        ...
        org.junit.Assert.assertEquals(
                "expect equals notify ", this.records[0].getNotify(), testResult.getNotify());
        assertEquals(
