...
public class OcCouponCategoryHandlerTestIt {
    static final String inputFile = "OcCouponCategory.json";
    static OcCouponCategoryHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcCouponCategoryId id =
                new OcCouponCategoryId(
                        this.records[0].getCategoryId(), this.records[0].getCouponId());
        OcCouponCategory testResult = jpa.find(OcCouponCategory.class, id);
