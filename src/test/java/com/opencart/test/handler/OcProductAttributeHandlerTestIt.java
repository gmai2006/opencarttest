...
public class OcProductAttributeHandlerTestIt {
    static final String inputFile = "OcProductAttribute.json";
    static OcProductAttributeHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcProductAttribute testResult = jpa.find(OcProductAttribute.class, id);
