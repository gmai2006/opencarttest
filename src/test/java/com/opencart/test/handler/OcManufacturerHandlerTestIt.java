...
public class OcManufacturerHandlerTestIt {
    static final String inputFile = "OcManufacturer.json";
    static OcManufacturerHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcManufacturer testResult = jpa.find(OcManufacturer.class, records[0].getManufacturerId());
