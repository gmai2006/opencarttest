...
public class OcLanguageHandlerTestIt {
    static final String inputFile = "OcLanguage.json";
    static OcLanguageHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcLanguage testResult = jpa.find(OcLanguage.class, records[0].getLanguageId());
        ...
        assertEquals("expect equals locale ", this.records[0].getLocale(), testResult.getLocale());
        assertEquals("expect equals image ", this.records[0].getImage(), testResult.getImage());
        assertEquals(
                "expect equals directory ",
                this.records[0].getDirectory(),
                testResult.getDirectory());
