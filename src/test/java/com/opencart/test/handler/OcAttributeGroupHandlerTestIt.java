...
public class OcAttributeGroupHandlerTestIt {
    static final String inputFile = "OcAttributeGroup.json";
    static OcAttributeGroupHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcAttributeGroup testResult =
                jpa.find(OcAttributeGroup.class, records[0].getAttributeGroupId());
