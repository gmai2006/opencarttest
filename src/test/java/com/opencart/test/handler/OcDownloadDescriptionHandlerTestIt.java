...
public class OcDownloadDescriptionHandlerTestIt {
    static final String inputFile = "OcDownloadDescription.json";
    static OcDownloadDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcDownloadDescriptionId id =
                new OcDownloadDescriptionId(
                        this.records[0].getLanguageId(), this.records[0].getDownloadId());
        OcDownloadDescription testResult = jpa.find(OcDownloadDescription.class, id);
