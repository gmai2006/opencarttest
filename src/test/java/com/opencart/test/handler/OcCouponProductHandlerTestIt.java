...
public class OcCouponProductHandlerTestIt {
    static final String inputFile = "OcCouponProduct.json";
    static OcCouponProductHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcCouponProduct[] records;
    ...
    public void testSelect() throws IOException {
        ...
        OcCouponProduct testResult =
                jpa.find(OcCouponProduct.class, records[0].getCouponProductId());
