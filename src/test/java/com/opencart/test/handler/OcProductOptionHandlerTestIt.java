...
public class OcProductOptionHandlerTestIt {
    static final String inputFile = "OcProductOption.json";
    static OcProductOptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcProductOption testResult =
                jpa.find(OcProductOption.class, records[0].getProductOptionId());
