...
public class OcMenuModuleHandlerTestIt {
    static final String inputFile = "OcMenuModule.json";
    static OcMenuModuleHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcMenuModule testResult = jpa.find(OcMenuModule.class, records[0].getMenuModuleId());
        org.junit.Assert.assertEquals(
                "expect equals menuId ", this.records[0].getMenuId(), testResult.getMenuId());
