...
public class OcLocationHandlerTestIt {
    static final String inputFile = "OcLocation.json";
    static OcLocationHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcLocation testResult = jpa.find(OcLocation.class, records[0].getLocationId());
        ...
        assertEquals(
                "expect equals geocode ", this.records[0].getGeocode(), testResult.getGeocode());
        assertEquals("expect equals image ", this.records[0].getImage(), testResult.getImage());
        assertEquals("expect equals open ", this.records[0].getOpen(), testResult.getOpen());
        assertEquals(
