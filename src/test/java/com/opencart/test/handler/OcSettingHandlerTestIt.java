...
public class OcSettingHandlerTestIt {
    static final String inputFile = "OcSetting.json";
    static OcSettingHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcSetting testResult = jpa.find(OcSetting.class, records[0].getSettingId());
        ...
        org.junit.Assert.assertEquals(
                ...
                this.records[0].getSerialized(),
                testResult.getSerialized());
