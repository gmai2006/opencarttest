...
public class OcProductFilterHandlerTestIt {
    static final String inputFile = "OcProductFilter.json";
    static OcProductFilterHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcProductFilterId id =
                new OcProductFilterId(
                        this.records[0].getFilterId(), this.records[0].getProductId());
        OcProductFilter testResult = jpa.find(OcProductFilter.class, id);
