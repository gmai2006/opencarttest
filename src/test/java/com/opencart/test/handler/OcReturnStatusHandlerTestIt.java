...
public class OcReturnStatusHandlerTestIt {
    static final String inputFile = "OcReturnStatus.json";
    static OcReturnStatusHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcReturnStatusId id =
                new OcReturnStatusId(
                        this.records[0].getReturnStatusId(), this.records[0].getLanguageId());
        OcReturnStatus testResult = jpa.find(OcReturnStatus.class, id);
