...
public class OcAttributeGroupDescriptionHandlerTestIt {
    static final String inputFile = "OcAttributeGroupDescription.json";
    static OcAttributeGroupDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcAttributeGroupDescriptionId id =
                new OcAttributeGroupDescriptionId(
                        this.records[0].getAttributeGroupId(), this.records[0].getLanguageId());
        OcAttributeGroupDescription testResult = jpa.find(OcAttributeGroupDescription.class, id);
