...
public class OcReviewHandlerTestIt {
    static final String inputFile = "OcReview.json";
    static OcReviewHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcReview testResult = jpa.find(OcReview.class, records[0].getReviewId());
        ...
        assertEquals("expect equals author ", this.records[0].getAuthor(), testResult.getAuthor());
        assertEquals("expect equals text ", this.records[0].getText(), testResult.getText());
        org.junit.Assert.assertEquals(
                "expect equals rating ", this.records[0].getRating(), testResult.getRating());
        org.junit.Assert.assertEquals(
