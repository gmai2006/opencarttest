...
public class OcFilterDescriptionHandlerTestIt {
    static final String inputFile = "OcFilterDescription.json";
    static OcFilterDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcFilterDescriptionId id =
                new OcFilterDescriptionId(
                        this.records[0].getFilterId(), this.records[0].getLanguageId());
        OcFilterDescription testResult = jpa.find(OcFilterDescription.class, id);
        org.junit.Assert.assertEquals(
                "expect equals filterGroupId ",
                this.records[0].getFilterGroupId(),
                testResult.getFilterGroupId());
