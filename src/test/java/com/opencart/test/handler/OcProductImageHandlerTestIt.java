...
public class OcProductImageHandlerTestIt {
    static final String inputFile = "OcProductImage.json";
    static OcProductImageHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcProductImage testResult = jpa.find(OcProductImage.class, records[0].getProductImageId());
