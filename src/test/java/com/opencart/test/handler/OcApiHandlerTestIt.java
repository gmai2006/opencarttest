...
public class OcApiHandlerTestIt {
    static final String inputFile = "OcApi.json";
    static OcApiHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcApi testResult = jpa.find(OcApi.class, records[0].getApiId());
