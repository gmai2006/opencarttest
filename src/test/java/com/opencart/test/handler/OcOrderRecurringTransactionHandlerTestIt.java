...
public class OcOrderRecurringTransactionHandlerTestIt {
    static final String inputFile = "OcOrderRecurringTransaction.json";
    static OcOrderRecurringTransactionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcOrderRecurringTransaction testResult =
                jpa.find(
                        ...
                        records[0].getOrderRecurringTransactionId());
        org.junit.Assert.assertEquals(
                "expect equals orderRecurringId ",
                this.records[0].getOrderRecurringId(),
                testResult.getOrderRecurringId());
        assertEquals(
