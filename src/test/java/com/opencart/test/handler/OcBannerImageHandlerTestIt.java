...
public class OcBannerImageHandlerTestIt {
    static final String inputFile = "OcBannerImage.json";
    static OcBannerImageHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcBannerImage testResult = jpa.find(OcBannerImage.class, records[0].getBannerImageId());
        org.junit.Assert.assertEquals(
                "expect equals bannerId ", this.records[0].getBannerId(), testResult.getBannerId());
        org.junit.Assert.assertEquals(
