...
public class OcVoucherThemeDescriptionHandlerTestIt {
    static final String inputFile = "OcVoucherThemeDescription.json";
    static OcVoucherThemeDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcVoucherThemeDescriptionId id =
                new OcVoucherThemeDescriptionId(
                        this.records[0].getVoucherThemeId(), this.records[0].getLanguageId());
        OcVoucherThemeDescription testResult = jpa.find(OcVoucherThemeDescription.class, id);
