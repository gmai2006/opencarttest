...
public class OcCustomFieldValueHandlerTestIt {
    static final String inputFile = "OcCustomFieldValue.json";
    static OcCustomFieldValueHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcCustomFieldValue testResult =
                jpa.find(OcCustomFieldValue.class, records[0].getCustomFieldValueId());
