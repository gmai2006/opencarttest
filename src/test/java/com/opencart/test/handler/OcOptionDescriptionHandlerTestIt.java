...
public class OcOptionDescriptionHandlerTestIt {
    static final String inputFile = "OcOptionDescription.json";
    static OcOptionDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcOptionDescriptionId id =
                new OcOptionDescriptionId(
                        this.records[0].getOptionId(), this.records[0].getLanguageId());
        OcOptionDescription testResult = jpa.find(OcOptionDescription.class, id);
