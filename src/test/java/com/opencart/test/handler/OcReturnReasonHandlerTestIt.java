...
public class OcReturnReasonHandlerTestIt {
    static final String inputFile = "OcReturnReason.json";
    static OcReturnReasonHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcReturnReasonId id =
                new OcReturnReasonId(
                        this.records[0].getReturnReasonId(), this.records[0].getLanguageId());
        OcReturnReason testResult = jpa.find(OcReturnReason.class, id);
