...
public class OcFilterGroupDescriptionHandlerTestIt {
    static final String inputFile = "OcFilterGroupDescription.json";
    static OcFilterGroupDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcFilterGroupDescriptionId id =
                new OcFilterGroupDescriptionId(
                        this.records[0].getLanguageId(), this.records[0].getFilterGroupId());
        OcFilterGroupDescription testResult = jpa.find(OcFilterGroupDescription.class, id);
