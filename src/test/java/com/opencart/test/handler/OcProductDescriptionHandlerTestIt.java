...
public class OcProductDescriptionHandlerTestIt {
    static final String inputFile = "OcProductDescription.json";
    static OcProductDescriptionHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcProductDescription[] records;
    ...
    public void testSelect() throws IOException {
        ...
        final OcProductDescriptionId id =
                new OcProductDescriptionId(
                        this.records[0].getProductId(), this.records[0].getLanguageId());
        OcProductDescription testResult = jpa.find(OcProductDescription.class, id);
        ...
        assertEquals("expect equals tag ", this.records[0].getTag(), testResult.getTag());
        assertEquals(
