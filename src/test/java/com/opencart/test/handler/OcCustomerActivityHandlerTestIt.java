...
public class OcCustomerActivityHandlerTestIt {
    static final String inputFile = "OcCustomerActivity.json";
    static OcCustomerActivityHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcCustomerActivity[] records;
    ...
    public void testSelect() throws IOException {
        ...
        OcCustomerActivity testResult =
                jpa.find(OcCustomerActivity.class, records[0].getCustomerActivityId());
