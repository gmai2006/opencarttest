...
public class OcReturnHistoryHandlerTestIt {
    static final String inputFile = "OcReturnHistory.json";
    static OcReturnHistoryHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcReturnHistory testResult =
                jpa.find(OcReturnHistory.class, records[0].getReturnHistoryId());
        org.junit.Assert.assertEquals(
                "expect equals returnId ", this.records[0].getReturnId(), testResult.getReturnId());
        org.junit.Assert.assertEquals(
