...
public class OcCustomerSearchHandlerTestIt {
    static final String inputFile = "OcCustomerSearch.json";
    static OcCustomerSearchHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcCustomerSearch testResult =
                jpa.find(OcCustomerSearch.class, records[0].getCustomerSearchId());
        ...
        org.junit.Assert.assertEquals(
                ...
                testResult.getCategoryId());
        org.junit.Assert.assertEquals(
                "expect equals subCategory ",
                this.records[0].getSubCategory(),
                testResult.getSubCategory());
        org.junit.Assert.assertEquals(
                "expect equals description ",
                this.records[0].getDescription(),
                testResult.getDescription());
        org.junit.Assert.assertEquals(
                "expect equals products ", this.records[0].getProducts(), testResult.getProducts());
