...
public class OcCustomerLoginHandlerTestIt {
    static final String inputFile = "OcCustomerLogin.json";
    static OcCustomerLoginHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcCustomerLogin[] records;
    ...
    public void testSelect() throws IOException {
        ...
        OcCustomerLogin testResult =
                jpa.find(OcCustomerLogin.class, records[0].getCustomerLoginId());
