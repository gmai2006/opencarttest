...
public class OcCustomerGroupHandlerTestIt {
    static final String inputFile = "OcCustomerGroup.json";
    static OcCustomerGroupHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcCustomerGroup[] records;
    ...
    public void testSelect() throws IOException {
        ...
        OcCustomerGroup testResult =
                jpa.find(OcCustomerGroup.class, records[0].getCustomerGroupId());
        org.junit.Assert.assertEquals(
                "expect equals approval ", this.records[0].getApproval(), testResult.getApproval());
        org.junit.Assert.assertEquals(
