...
public class OcUserHandlerTestIt {
    static final String inputFile = "OcUser.json";
    static OcUserHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcUser testResult = jpa.find(OcUser.class, records[0].getUserId());
        org.junit.Assert.assertEquals(
                "expect equals userGroupId ",
                this.records[0].getUserGroupId(),
                testResult.getUserGroupId());
        assertEquals(
