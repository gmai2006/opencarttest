...
public class OcLayoutRouteHandlerTestIt {
    static final String inputFile = "OcLayoutRoute.json";
    static OcLayoutRouteHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        records = gson.fromJson(json, OcLayoutRoute[].class);
        assertEquals("match count", count, records.length);
        OcLayoutRoute testResult = jpa.find(OcLayoutRoute.class, records[0].getLayoutRouteId());
        ...
        assertEquals("expect equals route ", this.records[0].getRoute(), testResult.getRoute());
