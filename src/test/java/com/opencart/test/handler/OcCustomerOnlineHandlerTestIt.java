...
public class OcCustomerOnlineHandlerTestIt {
    static final String inputFile = "OcCustomerOnline.json";
    static OcCustomerOnlineHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcCustomerOnline testResult = jpa.find(OcCustomerOnline.class, records[0].getIp());
