...
public class OcZoneToGeoZoneHandlerTestIt {
    static final String inputFile = "OcZoneToGeoZone.json";
    static OcZoneToGeoZoneHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcZoneToGeoZone testResult =
                jpa.find(OcZoneToGeoZone.class, records[0].getZoneToGeoZoneId());
        ...
        org.junit.Assert.assertEquals(
                ...
                this.records[0].getGeoZoneId(),
                testResult.getGeoZoneId());
