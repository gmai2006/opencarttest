...
public class OcOrderCustomFieldHandlerTestIt {
    static final String inputFile = "OcOrderCustomField.json";
    static OcOrderCustomFieldHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcOrderCustomField testResult =
                jpa.find(OcOrderCustomField.class, records[0].getOrderCustomFieldId());
        ...
        org.junit.Assert.assertEquals(
                ...
                this.records[0].getCustomFieldValueId(),
                testResult.getCustomFieldValueId());
