...
public class OcAffiliateLoginHandlerTestIt {
    static final String inputFile = "OcAffiliateLogin.json";
    static OcAffiliateLoginHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcAffiliateLogin[] records;
    ...
    public void testSelect() throws IOException {
        ...
        OcAffiliateLogin testResult =
                jpa.find(OcAffiliateLogin.class, records[0].getAffiliateLoginId());
        ...
        org.junit.Assert.assertEquals(
                "expect equals total ", this.records[0].getTotal(), testResult.getTotal());
