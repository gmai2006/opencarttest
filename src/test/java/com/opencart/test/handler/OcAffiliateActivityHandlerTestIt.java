...
public class OcAffiliateActivityHandlerTestIt {
    static final String inputFile = "OcAffiliateActivity.json";
    static OcAffiliateActivityHandler handler;
    ...
    static Gson gson =
            new GsonBuilder()
                    ...
                    .create();
    private OcAffiliateActivity[] records;
    ...
    public void testSelect() throws IOException {
        ...
        OcAffiliateActivity testResult =
                jpa.find(OcAffiliateActivity.class, records[0].getAffiliateActivityId());
