...
public class OcUserGroupHandlerTestIt {
    static final String inputFile = "OcUserGroup.json";
    static OcUserGroupHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcUserGroup testResult = jpa.find(OcUserGroup.class, records[0].getUserGroupId());
        assertEquals("expect equals name ", this.records[0].getName(), testResult.getName());
        assertEquals(
                "expect equals permission ",
                this.records[0].getPermission(),
