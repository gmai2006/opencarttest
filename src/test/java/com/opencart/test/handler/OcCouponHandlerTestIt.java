...
public class OcCouponHandlerTestIt {
    static final String inputFile = "OcCoupon.json";
    static OcCouponHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcCoupon testResult = jpa.find(OcCoupon.class, records[0].getCouponId());
        ...
        assertEquals(
                "expect equals discount ", this.records[0].getDiscount(), testResult.getDiscount());
        org.junit.Assert.assertEquals(
                "expect equals logged ", this.records[0].getLogged(), testResult.getLogged());
        org.junit.Assert.assertEquals(
        ...
        org.junit.Assert.assertEquals(
                ...
                this.records[0].getUsesTotal(),
                testResult.getUsesTotal());
        assertEquals(
                "expect equals usesCustomer ",
                this.records[0].getUsesCustomer(),
