...
public class OcStockStatusHandlerTestIt {
    static final String inputFile = "OcStockStatus.json";
    static OcStockStatusHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcStockStatusId id =
                new OcStockStatusId(
                        this.records[0].getStockStatusId(), this.records[0].getLanguageId());
        OcStockStatus testResult = jpa.find(OcStockStatus.class, id);
