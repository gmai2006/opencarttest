...
public class OcCustomFieldValueDescriptionHandlerTestIt {
    static final String inputFile = "OcCustomFieldValueDescription.json";
    static OcCustomFieldValueDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcCustomFieldValueDescriptionId id =
                new OcCustomFieldValueDescriptionId(
                        this.records[0].getCustomFieldValueId(), this.records[0].getLanguageId());
        OcCustomFieldValueDescription testResult =
                jpa.find(OcCustomFieldValueDescription.class, id);
        org.junit.Assert.assertEquals(
                "expect equals customFieldId ",
                this.records[0].getCustomFieldId(),
                testResult.getCustomFieldId());
