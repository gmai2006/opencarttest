...
public class OcCategoryPathHandlerTestIt {
    static final String inputFile = "OcCategoryPath.json";
    static OcCategoryPathHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcCategoryPathId id =
                new OcCategoryPathId(this.records[0].getCategoryId(), this.records[0].getPathId());
        OcCategoryPath testResult = jpa.find(OcCategoryPath.class, id);
