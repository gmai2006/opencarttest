...
public class OcProductToCategoryHandlerTestIt {
    static final String inputFile = "OcProductToCategory.json";
    static OcProductToCategoryHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcProductToCategoryId id =
                new OcProductToCategoryId(
                        this.records[0].getCategoryId(), this.records[0].getProductId());
        OcProductToCategory testResult = jpa.find(OcProductToCategory.class, id);
