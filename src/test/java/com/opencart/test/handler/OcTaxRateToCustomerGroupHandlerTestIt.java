...
public class OcTaxRateToCustomerGroupHandlerTestIt {
    static final String inputFile = "OcTaxRateToCustomerGroup.json";
    static OcTaxRateToCustomerGroupHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcTaxRateToCustomerGroupId id =
                new OcTaxRateToCustomerGroupId(
                        this.records[0].getTaxRateId(), this.records[0].getCustomerGroupId());
        OcTaxRateToCustomerGroup testResult = jpa.find(OcTaxRateToCustomerGroup.class, id);
