...
public class OcOptionValueDescriptionHandlerTestIt {
    static final String inputFile = "OcOptionValueDescription.json";
    static OcOptionValueDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcOptionValueDescriptionId id =
                new OcOptionValueDescriptionId(
                        this.records[0].getOptionValueId(), this.records[0].getLanguageId());
        OcOptionValueDescription testResult = jpa.find(OcOptionValueDescription.class, id);
