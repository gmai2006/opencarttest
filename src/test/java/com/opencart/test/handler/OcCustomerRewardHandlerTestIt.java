...
public class OcCustomerRewardHandlerTestIt {
    static final String inputFile = "OcCustomerReward.json";
    static OcCustomerRewardHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcCustomerReward testResult =
                jpa.find(OcCustomerReward.class, records[0].getCustomerRewardId());
