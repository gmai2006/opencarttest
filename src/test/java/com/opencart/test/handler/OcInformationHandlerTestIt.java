...
public class OcInformationHandlerTestIt {
    static final String inputFile = "OcInformation.json";
    static OcInformationHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcInformation testResult = jpa.find(OcInformation.class, records[0].getInformationId());
        org.junit.Assert.assertEquals(
                "expect equals bottom ", this.records[0].getBottom(), testResult.getBottom());
        org.junit.Assert.assertEquals(
