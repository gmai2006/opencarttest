...
public class OcModuleHandlerTestIt {
    static final String inputFile = "OcModule.json";
    static OcModuleHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcModule testResult = jpa.find(OcModule.class, records[0].getModuleId());
        ...
        assertEquals(
                "expect equals setting ", this.records[0].getSetting(), testResult.getSetting());
