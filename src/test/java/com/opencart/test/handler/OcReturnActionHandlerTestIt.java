...
public class OcReturnActionHandlerTestIt {
    static final String inputFile = "OcReturnAction.json";
    static OcReturnActionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcReturnActionId id =
                new OcReturnActionId(
                        this.records[0].getLanguageId(), this.records[0].getReturnActionId());
        OcReturnAction testResult = jpa.find(OcReturnAction.class, id);
