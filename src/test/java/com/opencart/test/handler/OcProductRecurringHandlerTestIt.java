...
public class OcProductRecurringHandlerTestIt {
    static final String inputFile = "OcProductRecurring.json";
    static OcProductRecurringHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcProductRecurring testResult = jpa.find(OcProductRecurring.class, id);
