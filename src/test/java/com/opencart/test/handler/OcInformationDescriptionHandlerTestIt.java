...
public class OcInformationDescriptionHandlerTestIt {
    static final String inputFile = "OcInformationDescription.json";
    static OcInformationDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcInformationDescriptionId id =
                new OcInformationDescriptionId(
                        this.records[0].getInformationId(), this.records[0].getLanguageId());
        OcInformationDescription testResult = jpa.find(OcInformationDescription.class, id);
