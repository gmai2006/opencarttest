...
public class OcRecurringDescriptionHandlerTestIt {
    static final String inputFile = "OcRecurringDescription.json";
    static OcRecurringDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcRecurringDescriptionId id =
                new OcRecurringDescriptionId(
                        this.records[0].getRecurringId(), this.records[0].getLanguageId());
        OcRecurringDescription testResult = jpa.find(OcRecurringDescription.class, id);
