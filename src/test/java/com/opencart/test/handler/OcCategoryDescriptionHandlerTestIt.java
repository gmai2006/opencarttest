...
public class OcCategoryDescriptionHandlerTestIt {
    static final String inputFile = "OcCategoryDescription.json";
    static OcCategoryDescriptionHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        final OcCategoryDescriptionId id =
                new OcCategoryDescriptionId(
                        this.records[0].getCategoryId(), this.records[0].getLanguageId());
        OcCategoryDescription testResult = jpa.find(OcCategoryDescription.class, id);
