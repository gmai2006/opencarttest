...
public class OcTaxRuleHandlerTestIt {
    static final String inputFile = "OcTaxRule.json";
    static OcTaxRuleHandler handler;
    ...
    public void testSelect() throws IOException {
        ...
        OcTaxRule testResult = jpa.find(OcTaxRule.class, records[0].getTaxRuleId());
        ...
        org.junit.Assert.assertEquals(
                ...
                this.records[0].getTaxRateId(),
                testResult.getTaxRateId());
        assertEquals("expect equals based ", this.records[0].getBased(), testResult.getBased());
        org.junit.Assert.assertEquals(
