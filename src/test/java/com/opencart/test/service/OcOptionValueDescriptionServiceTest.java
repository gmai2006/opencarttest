...
public class OcOptionValueDescriptionServiceTest {
    private static DefaultOcOptionValueDescriptionService serviceMock;
    private static OcOptionValueDescription[] records;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void setUp() {
        serviceMock = mock(DefaultOcOptionValueDescriptionService.class);
        String inputFile = "OcOptionValueDescription.json";
        try {
            String json =
        ...
        final OcOptionValueDescriptionId id =
                new OcOptionValueDescriptionId(
                        records[0].getOptionValueId(), records[0].getLanguageId());
    ...
    public void testFind_success() {
        final OcOptionValueDescriptionId id =
                new OcOptionValueDescriptionId(
                        records[0].getOptionValueId(), records[0].getLanguageId());
        OcOptionValueDescription testResult = serviceMock.find(id);
