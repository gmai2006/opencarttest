...
public class OcCategoryDescriptionServiceTest {
    private static DefaultOcCategoryDescriptionService serviceMock;
    private static OcCategoryDescription[] records;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void setUp() {
        serviceMock = mock(DefaultOcCategoryDescriptionService.class);
        String inputFile = "OcCategoryDescription.json";
        try {
            String json =
        ...
        final OcCategoryDescriptionId id =
                new OcCategoryDescriptionId(records[0].getCategoryId(), records[0].getLanguageId());
    ...
    public void testFind_success() {
        final OcCategoryDescriptionId id =
                new OcCategoryDescriptionId(records[0].getCategoryId(), records[0].getLanguageId());
        OcCategoryDescription testResult = serviceMock.find(id);
