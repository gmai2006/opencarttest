...
public class OcReturnServiceTest {
    private static DefaultOcReturnService serviceMock;
    private static OcReturn[] records;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void setUp() {
        serviceMock = mock(DefaultOcReturnService.class);
        String inputFile = "OcReturn.json";
        try {
            String json =
        ...
        // test data
        when(serviceMock.find(records[0].getReturnId())).thenReturn(records[0]);
    }

    @Test
    public void testFind_success() {
        OcReturn testResult = serviceMock.find(records[0].getReturnId());
        ...
        org.junit.Assert.assertEquals(
                "expect equals product ", records[0].getProduct(), testResult.getProduct());
        org.junit.Assert.assertEquals(
        ...
        org.junit.Assert.assertTrue(
                "expect equals opened ", records[0].getOpened() == testResult.getOpened());
        org.junit.Assert.assertTrue(
                "expect equals returnReasonId ",
                records[0].getReturnReasonId() == testResult.getReturnReasonId());
        org.junit.Assert.assertTrue(
                "expect equals returnActionId ",
                records[0].getReturnActionId() == testResult.getReturnActionId());
        org.junit.Assert.assertTrue(
                "expect equals returnStatusId ",
                records[0].getReturnStatusId() == testResult.getReturnStatusId());
        org.junit.Assert.assertEquals(
