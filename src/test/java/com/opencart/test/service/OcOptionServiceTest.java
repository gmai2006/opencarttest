...
public class OcOptionServiceTest {
    private static DefaultOcOptionService serviceMock;
    private static OcOption[] records;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void setUp() {
        serviceMock = mock(DefaultOcOptionService.class);
        String inputFile = "OcOption.json";
        try {
            String json =
                    FileUtils.readFileFromResource2String(inputFile, Charset.defaultCharset());
            records = gson.fromJson(json, OcOption[].class);
    ...
    public void testFind_success() {
        OcOption testResult = serviceMock.find(records[0].getOptionId());
