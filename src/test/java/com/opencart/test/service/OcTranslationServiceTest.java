...
public class OcTranslationServiceTest {
    private static DefaultOcTranslationService serviceMock;
    private static OcTranslation[] records;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void setUp() {
        serviceMock = mock(DefaultOcTranslationService.class);
        String inputFile = "OcTranslation.json";
        try {
            String json =
        ...
        // test data
        when(serviceMock.find(records[0].getTranslationId())).thenReturn(records[0]);
    }

    @Test
    public void testFind_success() {
        OcTranslation testResult = serviceMock.find(records[0].getTranslationId());
