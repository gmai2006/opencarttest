...
const columns = [
  { name: 'customerRewardId', header: 'customerRewardId', defaultFlex: 1 },
...
const loadData = () => {
  return fetch('/' + init.appName + '/rest/'  + 'occustomerreward/selectAll',{
    headers : {
...
export default OcCustomerReward;