...
const columns = [
  { name: 'voucherHistoryId', header: 'voucherHistoryId', defaultFlex: 1 },
...
const loadData = () => {
  return fetch('/' + init.appName + '/rest/'  + 'ocvoucherhistory/selectAll',{
    headers : {
...
export default OcVoucherHistory;