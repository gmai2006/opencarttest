...
const columns = [
  { name: 'affiliateActivityId', header: 'affiliateActivityId', defaultFlex: 1 },
...
const loadData = () => {
  return fetch('/' + init.appName + '/rest/'  + 'ocaffiliateactivity/selectAll',{
    headers : {
...
export default OcAffiliateActivity;