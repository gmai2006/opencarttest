...
const columns = [
  ...
  { name: 'symbolLeft', header: 'symbolLeft', defaultFlex: 1 },
  { name: 'symbolRight', header: 'symbolRight', defaultFlex: 1 },
  { name: 'decimalPlace', header: 'decimalPlace', defaultFlex: 1 },
...
const loadData = () => {
  return fetch('/' + init.appName + '/rest/'  + 'occurrency/selectAll',{
    headers : {
