...
const columns = [
  { name: 'couponHistoryId', header: 'couponHistoryId', defaultFlex: 1 },
...
const loadData = () => {
  return fetch('/' + init.appName + '/rest/'  + 'occouponhistory/selectAll',{
    headers : {
...
export default OcCouponHistory;