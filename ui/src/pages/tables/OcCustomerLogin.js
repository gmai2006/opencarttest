...
const columns = [
  { name: 'customerLoginId', header: 'customerLoginId', defaultFlex: 1 },
...
const loadData = () => {
  return fetch('/' + init.appName + '/rest/'  + 'occustomerlogin/selectAll',{
    headers : {
...
export default OcCustomerLogin;