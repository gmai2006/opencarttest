...
const columns = [
  { name: 'productDiscountId', header: 'productDiscountId', defaultFlex: 1 },
...
const loadData = () => {
  return fetch('/' + init.appName + '/rest/'  + 'ocproductdiscount/selectAll',{
    headers : {
...
export default OcProductDiscount;